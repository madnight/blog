...
(function () {
  ...
  FP.List.Cons = FP.List.Subclass({
    ...
    at: function (index) {
      if (index < 0 || index >= this.length()) {
        throw Error("no such element at " + index +
          ". index must be lower than " + this.length() + ".");
      }
      var t = this;
    ...
    unapply: function (x) {
      return FP.Option.Some([x.head, x.tail]);
    }
  });
  ...
  FP.OffsetPosition = MathJax.Object.Subclass({
    ...
    isLessThan: function (that) {
      if (that.isa(FP.OffsetPosition)) {
        ...
        return (
          this.line() < that.line() ||
          (this.line() === that.line() && this.column() < that
          .column())
        );
      }
    }
  ...
  FP.StringReader = MathJax.Object.Subclass({
    ...
    rest: function () {
      if (this.offset < this.source.length) {
        return FP.StringReader(this.source, this.offset + 1, this
          .context);
      } else {
        return this;
      }
    ...
    pos: function () {
      return FP.OffsetPosition(this.source, this.offset);
    },
    atEnd: function () {
  ...
  FP.Parsers = MathJax.Object.Subclass({}, {
    ...
    parseAll: function (p, input) {
      return p.andl(function () {
        return FP.Parsers.eos();
      }).apply(input);
    },
    parseString: function (p, str) {
      var input = FP.StringReader(str, 0, {
    ...
    _handleWhiteSpace: function (input) {
      ...
      var m = whiteSpaceRegex.exec(source.substring(offset, source
        .length));
      if (m !== null) {
    ...
    regex: function (rx /* must start with ^ */ ) {
      ...
      return FP.Parsers.Parser(function (input) {
        ...
        if (m !== null) {
          ...
          return FP.Parsers.Failure(
            "string matching regex " + rx + " expected but " +
            found + " found",
            input
          );
        }
    ...
    regexLiteral: function (rx /* must start with ^ */ ) {
      ...
      return FP.Parsers.Parser(function (input) {
        ...
        if (m !== null) {
          return FP.Parsers.Success(m[0], input.drop(start + m[0]
            .length - offset));
        } else {
          if (start === source.length) {
            found = "end of source";
    ...
    commit: function ( /*lazy*/ p) {
      return FP.Parsers.Parser(function (input) {
        var res = p()(input);
        return (FP.Matcher()
          .Case(FP.Parsers.Success, function (x) {
            return res;
          })
          .Case(FP.Parsers.Error, function (x) {
            return res;
          })
    ...
    elem: function (e) {
      return FP.Parsers.accept(e).named('"' + e + '"');
    },
    accept: function (e) {
    ...
    rep: function ( /*lazy*/ p) {
      ...
      return FP.Parsers.rep1(p).or(function () {
        return s;
      });
    },
    ...
    repsep: function ( /*lazy*/ p, /*lazy*/ q) {
      var s = FP.Parsers.success(FP.List.empty);
      return FP.Parsers.rep1sep(p, q).or(function () {
        return s;
      });
    },
    ...
    chainl1: function ( /*lazy*/ first, /*lazy*/ p, /*lazy*/ q) {
      return first().and(FP.Parsers.rep(q().and(p))).to(function (res) {
        return res.tail.foldLeft(res.head, function (a, fb) {
          return fb.head(a, fb.tail);
        });
      });
    },
    chainr1: function ( /*lazy*/ p, /*lazy*/ q, combine, first) {
      return p().and(this.rep(q().and(p))).to(function (res) {
        return FP.List.Cons(FP.Parsers.Pair(combine, res.head),
          res.tail).foldRight(first, function (fa, b) {
          return fa.head(fa.tail, b);
        });
      });
    },
    opt: function ( /*lazy*/ p) {
    ...
    //phrase: function (p)
    mkList: function (pair) {
      return FP.List.Cons(pair.head, pair.tail);
    },
    fun: function (x) {
      return function () {
        return x;
    ...
    seq: function () {
      ...
      if (count === 0) {
        return FP.Parsers.err("at least one element must be specified");
      }
  ...
  FP.Parsers.Success = FP.Parsers.ParseResult.Subclass({
    ...
    unapply: function (x) {
      return FP.Option.Some([x.result, x.next]);
    }
  });
  /************ NoSuccess **************/
  FP.Parsers.NoSuccess = FP.Parsers.ParseResult.Subclass({
    ...
    _setLastNoSuccess: function () {
      ...
      if (context.lastNoSuccess === undefined || !this.next.pos()
        .isLessThan(context.lastNoSuccess.next.pos())) {
    ...
    get: function () {
      return FP.Parsers.error("No result when parsing failed");
    },
    successful: false
  });
  /************ Failure **************/
  FP.Parsers.Failure = FP.Parsers.NoSuccess.Subclass({
    ...
    unapply: function (x) {
      return FP.Option.Some([x.msg, x.next]);
    }
  });
  /************ Error **************/
  ...
  FP.Parsers.Parser = MathJax.Object.Subclass({
    ...
    ret: function ( /*lazy*/ v) {
      var app = this.apply;
      return FP.Parsers.Parser(function (input) {
        return app(input).map(function (x) {
          return v();
        });
      }).named(this.toString() + "^^^");
    },
    toIfPossible: function (f, error) {
      if (error === undefined) {
        error = function (r) {
          return "Constructor function not defined at " + r;
        };
      }
      var app = this.apply;
      return FP.Parsers.Parser(function (input) {
    ...
    rep: function () {
      var p = this;
      return FP.Parsers.rep(function () {
        return p;
      });
    },
    ...
    rep1: function () {
      var p = this;
      return FP.Parsers.rep1(function () {
        return p;
      });
    },
    opt: function () {
      var p = this;
      return FP.Parsers.opt(function () {
        return p;
      });
    }
  });
...
MathJax.Extension.xypic = {
  ...
  signalHandler: {
    ...
    chainSignal: function (successor, predecessors) {
      ...
      MathJax.Extension.xypic.signalHandler.chains.push({
        succ: successor,
        pred: predecessors
      });
    },
    addSignal: function (signal) {
      ...
      var handler = MathJax.Extension.xypic.signalHandler.handleSignal(
        signal);
...
MathJax.Extension.xypic.signalHandler.chainSignal("TeX Xy-pic Require", [
  "Functional Programming library Ready", "TeX Jax Ready"]);
// "HTML-CSS Xy-pic Config" depends on "TeX Xy-pic" and "HTML-CSS Jax".
MathJax.Extension.xypic.signalHandler.chainSignal(
  "HTML-CSS Xy-pic Config Require", ["TeX Xy-pic Ready", "HTML-CSS Jax Ready"]
  );
// "SVG Xy-pic Config" depends on "TeX Xy-pic" and "SVG Jax".
MathJax.Extension.xypic.signalHandler.chainSignal("SVG Xy-pic Config Require", [
  "TeX Xy-pic Ready", "SVG Jax Ready"]);
// "Device-Independent Xy-pic" depends on "TeX Xy-pic" OR "SVG Jax".
MathJax.Extension.xypic.signalHandler.chainSignal(
  "Device-Independent Xy-pic Require", ["HTML-CSS Xy-pic Config Ready"]);
MathJax.Extension.xypic.signalHandler.chainSignal(
  "Device-Independent Xy-pic Require", ["SVG Xy-pic Config Ready"]);
// "HTML-CSS Xy-pic" depends on "HTML-CSS Xy-pic Config" and "Device-Independent Xy-pic".
MathJax.Extension.xypic.signalHandler.chainSignal("HTML-CSS Xy-pic Require", [
  "HTML-CSS Xy-pic Config Ready", "Device-Independent Xy-pic Ready"]);
// "SVG Xy-pic" depends on "SVG Xy-pic Config" and "Device-Independent Xy-pic".
MathJax.Extension.xypic.signalHandler.chainSignal("SVG Xy-pic Require", [
  "SVG Xy-pic Config Ready", "Device-Independent Xy-pic Ready"]);
MathJax.Hub.Register.StartupHook("TeX Xy-pic Require", function () {
  ...
  AST.ObjectBox.Curve = AST.ObjectBox.Subclass({
    ...
    toString: function () {
      return "\\curve" + this.modifiers.mkString("") + "{" + this
        .objects.mkString(" ") + " " + this.poslist.mkString("&") +
        "}";
    }
  });
  ...
  AST.Command.Path.Segment = MathJax.Object.Subclass({
    ...
    toString: function () {
      return this.pos.toString() + " " + this.slide + " " + this
        .labels;
    }
  });
  // <labels> ::= <label>*
  ...
  AST.Command.Path.Label.Above = AST.Command.Path.Label.Subclass({
    toString: function () {
      return "^(" + this.anchor + " " + this.it + " " + this
        .aliasOption + ")";
    }
  });
  ...
  AST.Command.Path.Label.Below = AST.Command.Path.Label.Subclass({
    toString: function () {
      return "_(" + this.anchor + " " + this.it + " " + this
        .aliasOption + ")";
    }
  });
  // <label> ::= '|' <anchor> <it> <alias>?
  ...
  AST.Command.Ar.Form.BuildArrow = AST.Command.Ar.Form.Subclass({
    ...
    toString: function () {
      return "@" + this.variant + "{" + this.tailTip.toString() +
        ", " + this.stemConn.toString() + ", " + this.headTip
        .toString() + "}";
    }
  });
  // <arrow_form> ::= '@' <variant>
  ...
  AST.Command.Xymatrix.Setup.ChangeSpacing.Row = AST.Command.Xymatrix.Setup
    .ChangeSpacing.Subclass({
      toString: function () {
        return "@R" + this.addop + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.ChangeSpacing.Column = AST.Command.Xymatrix
    .Setup.ChangeSpacing.Subclass({
      toString: function () {
        return "@C" + this.addop + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.ChangeSpacing.RowAndColumn = AST.Command
    .Xymatrix.Setup.ChangeSpacing.Subclass({
      toString: function () {
  ...
  AST.Command.Xymatrix.Setup.PretendEntrySize.Height = AST.Command.Xymatrix
    .Setup.PretendEntrySize.Subclass({
      toString: function () {
        return "@!R=" + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.PretendEntrySize.Width = AST.Command.Xymatrix
    .Setup.PretendEntrySize.Subclass({
      toString: function () {
        return "@!C=" + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.PretendEntrySize.HeightAndWidth = AST.Command
    .Xymatrix.Setup.PretendEntrySize.Subclass({
      toString: function () {
        return "@!=" + this.dimen;
      }
    });
  ...
  AST.Command.Xymatrix.Setup.FixGrid.Row = AST.Command.Xymatrix.Setup
    .FixGrid.Subclass({
      toString: function () {
        return "@!R";
      }
    });
  AST.Command.Xymatrix.Setup.FixGrid.Column = AST.Command.Xymatrix.Setup
    .FixGrid.Subclass({
      toString: function () {
        return "@!C";
      }
    });
  AST.Command.Xymatrix.Setup.FixGrid.RowAndColumn = AST.Command.Xymatrix
    .Setup.FixGrid.Subclass({
      toString: function () {
        return "@!";
      }
    });
  ...
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Margin = AST.Command.Xymatrix
    .Setup.AdjustEntrySize.Subclass({
      toString: function () {
        return "@M" + this.addop + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Width = AST.Command.Xymatrix
    .Setup.AdjustEntrySize.Subclass({
      toString: function () {
        return "@W" + this.addop + this.dimen;
      }
    });
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Height = AST.Command.Xymatrix
    .Setup.AdjustEntrySize.Subclass({
      toString: function () {
  ...
  AST.Command.Xymatrix.Entry.SimpleEntry = AST.Command.Xymatrix.Entry
    .Subclass({
      /**
      ...
      isEmpty: false,
      toString: function () {
        return this.modifiers.mkString("**{", "", "}") + " " + this
          .objectbox + " " + this.decor;
      }
    });
  AST.Command.Xymatrix.Entry.ObjectEntry = AST.Command.Xymatrix.Entry
    .Subclass({
      /**
  ...
  AST.Command.Xymatrix.Entry.EmptyEntry = AST.Command.Xymatrix.Entry
    .Subclass({
      /**
       * @param {AST.Decor} decor decoration
       */
  ...
  AST.Command.Twocell = MathJax.Object.Subclass({
    ...
    toString: function () {
      return this.twocell.toString() + this.switches.mkString("") +
        this.arrow;
    }
  });
  ...
  AST.Command.Twocell.Twocell = AST.Command.Twocell.Hops2cell.Subclass({
    toString: function () {
      return "\\xtwocell[" + this.hops + "]" + this.maybeDisplace
        .getOrElse("{}");
    }
  });
  //           |   '\' /[lrud]+/ 'uppertwocell'
  //           |   '\xuppertwocell' '[' /[lrud]+/ ']' '{' <text> '}'
  AST.Command.Twocell.UpperTwocell = AST.Command.Twocell.Hops2cell
.Subclass({
    toString: function () {
      return "\\xuppertwocell[" + this.hops + "]" + this.maybeDisplace
        .getOrElse("{}");
    }
  });
  //           |   '\' /[lrud]+/ 'lowertwocell'
  //           |   '\xlowertwocell' '[' /[lrud]+/ ']' '{' <text> '}'
  AST.Command.Twocell.LowerTwocell = AST.Command.Twocell.Hops2cell
.Subclass({
    toString: function () {
      return "\\xlowertwocell[" + this.hops + "]" + this.maybeDisplace
        .getOrElse("{}");
    }
  });
  //           |   '\' /[lrud]+/ 'compositemap'
  //           |   '\xcompositemap' '[' /[lrud]+/ ']' '{' <text> '}'
  AST.Command.Twocell.CompositeMap = AST.Command.Twocell.Hops2cell
.Subclass({
    toString: function () {
      return "\\xcompositemap[" + this.hops + "]" + this.maybeDisplace
        .getOrElse("{}");
    }
  });
  ...
  //          |   '\omit'
  AST.Command.Twocell.Switch.DoNotSetCurvedArrows = MathJax.Object
.Subclass({
    toString: function () {
      return "\\omit";
    }
  ...
  //          |   '~' ( '`' | "'" ) '{' <object> '}'
  AST.Command.Twocell.Switch.ChangeHeadTailObject = MathJax.Object
.Subclass({
    /**
     * @param {String} what
  ...
  AST.Command.Twocell.Switch.ChangeCurveObject = MathJax.Object.Subclass({
    ...
    toString: function () {
      return "~" + this.what + "{" + this.spacer + (this.maybeObject
        .isDefined ? "~**" + this.maybeObject.get : "") + "}";
    }
  });
  ...
  AST.Command.Twocell.Arrow.WithOrientation = AST.Command.Twocell.Arrow
    .Subclass({
      /**
       * @param {String} tok
       * @param {AST.Object} labelObject
  ...
  AST.Command.Twocell.Arrow.WithPosition = AST.Command.Twocell.Arrow
    .Subclass({
      /**
       * @param {AST.Command.Twocell.Nudge.*} nudge
       * @param {AST.Object} labelObject
  ...
  AST.Pos.Xyimport.TeXCommand = AST.Pos.Xyimport.Subclass({
    ...
    toString: function () {
      return "\\xyimport(" + this.width + ", " + this.height + ")(" +
        this.xOffset + ", " + this.yOffset + "){" + this.graphics +
        "}";
    }
  });
  ...
  AST.Command.Includegraphics = MathJax.Object.Subclass({
    ...
    toString: function () {
      return "\\includegraphics" + (this.isClipped ? "*" : "") + this
        .attributeList.mkString("[", ",", "]") + "{" + this.filepath +
        "}";
    }
  });
  ...
  AST.Command.Includegraphics.Attr.Width = AST.Command.Includegraphics.Attr
    .Subclass({
      /**
       * @param {String} dimen 
       */
  ...
  AST.Command.Includegraphics.Attr.Height = AST.Command.Includegraphics.Attr
    .Subclass({
      /**
       * @param {String} dimen 
       */
  ...
  var felem = function (x) {
    return fun(FP.Parsers.elem(x));
  }
  var lit = FP.Parsers.literal;
  var regex = FP.Parsers.regex;
  var regexLit = FP.Parsers.regexLiteral;
  var flit = function (x) {
    return fun(FP.Parsers.literal(x));
  }
  var seq = FP.Parsers.seq;
  var or = FP.Parsers.or;
  var rep = function (x) {
    return FP.Parsers.lazyParser(x)().rep();
  }
  var rep1 = function (x) {
    return FP.Parsers.lazyParser(x)().rep1();
  }
  var opt = function (x) {
    return FP.Parsers.lazyParser(x)().opt();
  }
  var not = function (x) {
    return FP.Parsers.not(FP.Parsers.lazyParser(x));
  }
  ...
  var p = FP.Parsers.Subclass({
    ...
    xy: memo(function () {
      return p.posDecor().into(function (pd) {
        return FP.Parsers.guard(function () {
          return lit('\\end').andl(flit('{')).andl(flit(
            'xy')).andl(flit('}')).to(function () {
            return pd;
          })
        });
      });
    ...
    // '{' <pos-decor> '}'
    xybox: memo(function () {
      return lit("{").andr(p.posDecor).andl(flit("}")).to(function (
        pd) {
        return pd;
      });
    }),
    ...
    xymatrixbox: memo(function () {
      return p.xymatrix().to(function (m) {
        return AST.PosDecor(AST.Pos.Coord(AST.Coord.C(), FP.List
          .empty), AST.Decor(FP.List.empty.append(m)));
      });
    }),
    // <pos-decor> ::= <pos> <decor>
    ...
    pos2: memo(function () {
      return or(
        lit('+').andr(p.coord).to(function (c) {
          return AST.Pos.Plus(c);
        }),
        lit('-').andr(p.coord).to(function (c) {
          return AST.Pos.Minus(c);
        }),
        lit('!').andr(p.coord).to(function (c) {
          return AST.Pos.Skew(c);
        }),
        lit('.').andr(p.coord).to(function (c) {
          return AST.Pos.Cover(c);
        }),
        lit(',').andr(p.coord).to(function (c) {
          return AST.Pos.Then(c);
        }),
        lit(';').andr(p.coord).to(function (c) {
          return AST.Pos.SwapPAndC(c);
        }),
        lit('::').andr(p.coord).to(function (c) {
          return AST.Pos.SetYBase(c);
        }),
        lit(':').andr(p.coord).to(function (c) {
          return AST.Pos.SetBase(c);
        }),
        lit('**').andr(p.object).to(function (o) {
          return AST.Pos.ConnectObject(o);
        }),
        lit('*').andr(p.object).to(function (o) {
          return AST.Pos.DropObject(o);
        }),
        lit('?').andr(p.place).to(function (o) {
          return AST.Pos.Place(o);
        }),
        lit('@+').andr(p.coord).to(function (c) {
          return AST.Pos.PushCoord(c);
        }),
        lit('@-').andr(p.coord).to(function (c) {
          return AST.Pos.EvalCoordThenPop(c);
        }),
        lit('@=').andr(p.coord).to(function (c) {
          return AST.Pos.LoadStack(c);
        }),
        lit('@@').andr(p.coord).to(function (c) {
          return AST.Pos.DoCoord(c);
        }),
        lit('@i').to(function () {
          return AST.Pos.InitStack();
        }),
        lit('@(').to(function () {
          return AST.Pos.EnterFrame();
        }),
        lit('@)').to(function () {
          return AST.Pos.LeaveFrame();
        }),
        lit('=:').andr(flit('"')).andr(p.id).andl(felem('"')).to(
          function (id) {
            return AST.Pos.SaveBase(id);
          }),
        lit('=@').andr(flit('"')).andr(p.id).andl(felem('"')).to(
          function (id) {
            return AST.Pos.SaveStack(id);
          }),
        lit('=').andr(flit('"')).andr(p.id).andl(felem('"')).to(
          function (id) {
            return AST.Pos.SavePos(id);
          }),
        lit('=').andr(p.nonemptyCoord).andl(flit('"')).and(p.id)
        .andl(felem('"')).to(function (mid) {
          return AST.Pos.SaveMacro(mid.head, mid.tail);
        }),
        p.xyimport
      );
    }),
    ...
    nonemptyCoord: memo(function () {
      return or(
        ...
        p.vector().to(function (v) {
          return AST.Coord.Vector(v);
        }),
        lit('"').andr(p.id).andl(felem('"')).to(function (id) {
          return AST.Coord.Id(id)
        }),
        lit('{').andr(p.posDecor).andl(flit('}')).to(function (
        pd) {
          return AST.Coord.Group(pd)
        }),
        lit('s').andr(fun(regexLit(/^\d/))).to(function (n) {
          return AST.Coord.StackPosition(parseInt(n));
        }),
        lit('s').andr(flit('{')).and(p.nonnegativeNumber).andl(
          flit('}')).to(function (n) {
          return AST.Coord.StackPosition(n);
        }),
        lit('[').andr(fun(
          opt(lit('"').andr(p.id).andl(felem('"'))).to(
            function (id) {
              return id.getOrElse("");
            }))).and(p.number).andl(flit(",")).and(p.number).andl(
          flit("]")).to(function (prc) {
          return AST.Coord.DeltaRowColumn(prc.head.head, prc
            .head.tail, prc.tail);
        }),
        lit('[').andr(fun(
          opt(lit('"').andr(p.id).andl(felem('"'))).to(
            function (id) {
              return id.getOrElse("");
            }))).and(fun(rep(regex(/^[lrud]/)))).andl(flit("]"))
        .to(function (ph) {
        ...
        lit('[').andr(fun(
          opt(lit('"').andr(p.id).andl(felem('"'))).to(
            function (id) {
              return id.getOrElse("");
            }))).and(fun(rep1(regex(/^[lrud]/)))).and(p.place)
        .andl(flit("]")).to(function (php) {
          return AST.Coord.DeltaRowColumn(php.head.head, php
            .head.tail, AST.Pos.Place(php.tail));
        })
      );
    }),
    // <vector> ::= '(' <factor> ',' <factor> ')'
    ...
    vector: memo(function () {
      return or(
        lit('(').andr(p.factor).andl(flit(',')).and(p.factor)
        .andl(flit(')')).to(
          function (xy) {
            return AST.Vector.InCurBase(xy.head, xy.tail);
          }
        ),
        lit('<').andr(p.dimen).andl(flit(',')).and(p.dimen).andl(
          flit('>')).to(
          function (xy) {
        ...
        lit('a').andr(flit('(')).andr(p.number).andl(flit(')'))
        .to(
          function (d) {
            return AST.Vector.Angle(d);
          }
        ),
        lit('/').andr(p.direction).and(p.looseDimen).andl(flit(
          '/')).to(
          function (dd) {
        ...
        lit('0').to(function (x) {
          return AST.Vector.Abs("0mm", "0mm");
        }),
        function () {
          return p.corner().and(fun(FP.Parsers.opt(
              fun(lit('(').andr(p.factor).andl(flit(')'))))
            .to(function (f) {
    ...
    corner: memo(function () {
      return or(
        regexLit(/^(CL|LC)/).to(function () {
          return AST.Corner.CL();
        }),
        regexLit(/^(CR|RC)/).to(function () {
          return AST.Corner.CR();
        }),
        regexLit(/^(CD|DC)/).to(function () {
          return AST.Corner.CD();
        }),
        regexLit(/^(CU|UC)/).to(function () {
          return AST.Corner.CU();
        }),
        regexLit(/^(LD|DL)/).to(function () {
          return AST.Corner.LD();
        }),
        regexLit(/^(RD|DR)/).to(function () {
          return AST.Corner.RD();
        }),
        regexLit(/^(LU|UL)/).to(function () {
          return AST.Corner.LU();
        }),
        regexLit(/^(RU|UR)/).to(function () {
          return AST.Corner.RU();
        }),
        lit('L').to(function () {
          return AST.Corner.L();
        }),
        ...
        lit('E').to(function () {
          return AST.Corner.NearestEdgePoint();
        }),
        lit('P').to(function () {
          return AST.Corner.PropEdgePoint();
        }),
        lit('A').to(function () {
          return AST.Corner.Axis();
        })
      );
    }),
    // <place> ::= '<' <place>
    ...
    place: memo(function () {
      return or(
        lit('<').andr(p.place).to(function (pl) {
          return AST.Place(1, 0, undefined, undefined).compound(
            pl);
        }),
        lit('>').andr(p.place).to(function (pl) {
          return AST.Place(0, 1, undefined, undefined).compound(
            pl);
        }),
        lit('(').andr(p.factor).andl(flit(')')).and(p.place).to(
          function (pl) {
            return AST.Place(0, 0, AST.Place.Factor(pl.head),
              undefined).compound(pl.tail);
          }),
        lit('!').andr(flit('{')).andr(p.pos).andl(flit('}')).and(p
          .slide).to(function (ps) {
          return AST.Place(0, 0, AST.Place.Intercept(ps.head),
            ps.tail);
        }),
        function () {
          return p.slide().to(function (s) {
    ...
    unit: memo(fun(regexLit(/^(em|ex|px|pt|pc|in|cm|mm|mu)/).to(
      function (d) {
        return d
      }))),
    ...
    objectbox: memo(function () {
      return or(
        ...
        lit("@").andr(p.dir),
        lit("\\dir").andr(p.dir),
        lit("\\cir").andr(p.cirRadius).andl(flit("{")).and(p.cir)
        .andl(flit("}")).to(function (rc) {
          return AST.ObjectBox.Cir(rc.head, rc.tail);
        }),
        lit("\\frm").andr(p.frameRadius).andl(flit("{")).and(p
          .frameMain).andl(flit("}")).to(function (rm) {
          return AST.ObjectBox.Frame(rm.head, rm.tail);
        }),
        lit("\\object").andr(p.object).to(function (o) {
          return AST.ObjectBox.WrapUpObject(o);
        }),
        lit("\\composite").and(flit("{")).andr(p.compositeObject)
        .andl(flit("}")).to(function (os) {
          return AST.ObjectBox.CompositeObject(os);
        }),
        lit("\\xybox").and(flit("{")).andr(p.posDecor).andl(flit(
          "}")).to(function (pd) {
        ...
        p.txt,
        p.curve,
        regex(/^(\\[a-zA-Z@][a-zA-Z0-9@]+)/).andl(flit("{")).and(p
          .text).andl(flit("}")).to(function (bt) {
    ...
    compositeObject: memo(function () {
      return p.object().and(fun(rep(lit("*").andr(p.object)))).to(
        function (oos) {
    ...
    mathText: memo(function () {
      return lit("{").andr(p.text).andl(felem("}")).to(function (
        text) {
      ...
      return regex(/^[^{}\\%]*/).and(function () {
        return (
          or(
            ...
            elem("{").andr(p.text).andl(felem("}")).to(
              function (x) {
                return "{" + x + "}";
              }),
            regex(/^%[^\r\n]*(\r\n|\r|\n)?/).to(function (x) {
    ...
    txt: memo(function () {
      return lit("\\txt").andr(p.txtWidth).and(fun(regex(
        /^(\\[a-zA-Z@][a-zA-Z0-9@]+)?/))).andl(flit("{")).and(p
        .text).andl(flit("}")).to(function (wst) {
    ...
    // <variant> ::= '^' | '_' | '0' | '1' | '2' | '3' | <empty>
    dir: memo(function () {
      return regexLit(/^[\^_0123]/).opt().andl(flit('{')).and(p
        .dirMain).andl(flit('}')).to(function (vm) {
        return AST.ObjectBox.Dir(vm.head.getOrElse(""), vm
        .tail);
      })
    }),
    // <main> ::= ('-' | '.' | '~' | '>' | '<' | '(' | ')' | '`' | "'" | '|' | '*' | '+' | 'x' | '/' | 'o' | '=' | ':' | /[a-zA-Z@ ]/)*
    ...
    nonemptyCir: memo(function () {
      return p.diag().and(fun(regexLit(/^[_\^]/))).and(p.diag).to(
        function (dod) {
          return AST.ObjectBox.Cir.Cir.Segment(dod.head.head, dod
            .head.tail, dod.tail);
        });
    }),
    // <curve> ::= '\crv' <curve-modifier> '{' <curve-object> <curve-poslist> '}'
    curve: memo(function () {
      return lit("\\crv").andr(p.curveModifier).andl(flit("{")).and(
        p.curveObject).and(p.curvePoslist).andl(flit("}")).to(
        function (mop) {
          return AST.ObjectBox.Curve(mop.head.head, mop.head.tail,
            mop.tail);
        });
    }),
    // <curve-modifier> ::= ( '~' <curve-option> )*
    ...
    curveOption: memo(function () {
      return or(
        lit("p").to(function () {
          return AST.ObjectBox.Curve.Modifier.p();
        }),
        lit("P").to(function () {
          return AST.ObjectBox.Curve.Modifier.P();
        }),
        lit("l").to(function () {
          return AST.ObjectBox.Curve.Modifier.l();
        }),
        lit("L").to(function () {
          return AST.ObjectBox.Curve.Modifier.L();
        }),
        lit("c").to(function () {
          return AST.ObjectBox.Curve.Modifier.c();
        }),
        lit("C").to(function () {
          return AST.ObjectBox.Curve.Modifier.C();
        }),
        lit("pc").to(function () {
          return AST.ObjectBox.Curve.Modifier.pc();
        }),
        lit("pC").to(function () {
          return AST.ObjectBox.Curve.Modifier.pC();
        }),
        ...
        lit("lc").to(function () {
          return AST.ObjectBox.Curve.Modifier.lc();
        }),
        lit("lC").to(function () {
          return AST.ObjectBox.Curve.Modifier.lC();
        }),
        ...
        lit("cC").to(function () {
          return AST.ObjectBox.Curve.Modifier.cC();
        })
      );
    }),
    // <curve-object> ::= <empty>
    ...
    curvePoslist: memo(function () {
      return or(
        lit("&").andr(p.curvePoslist2).to(function (ps) {
          return ps.prepend(AST.ObjectBox.Curve.PosList
          .CurPos());
        }),
        lit("~@").andr(flit("&")).andr(p.curvePoslist2).to(
          function (ps) {
            return ps.prepend(AST.ObjectBox.Curve.PosList
              .AddStack());
          }),
        lit("~@").to(function () {
          return FP.List.empty.prepend(AST.ObjectBox.Curve
            .PosList.AddStack());
        }),
        p.pos().andl(flit("&")).and(p.curvePoslist2).to(function (
          pps) {
          return pps.tail.prepend(AST.ObjectBox.Curve.PosList
            .Pos(pps.head));
        }),
    ...
    curvePoslist2: memo(function () {
      return or(
        ...
        p.nonemptyPos().andl(flit("&")).and(p.curvePoslist2).to(
          function (pps) {
            return pps.tail.prepend(AST.ObjectBox.Curve.PosList
              .Pos(pps.head));
          }),
    ...
    addOp: memo(function () {
      return or(
        lit("+=").to(function () {
          return AST.Modifier.AddOp.GrowTo();
        }),
        lit("-=").to(function () {
          return AST.Modifier.AddOp.ShrinkTo();
        }),
        lit("+").to(function () {
          return AST.Modifier.AddOp.Grow();
        }),
        lit("-").to(function () {
          return AST.Modifier.AddOp.Shrink();
        }),
        lit("=").to(function () {
          return AST.Modifier.AddOp.Set();
        })
      );
    }),
    // <size> ::= <vector> | <empty>
    ...
    shape: memo(function () {
      return or(
        lit(".").to(function () {
          return AST.Modifier.Shape.Point();
        }),
        p.frameShape,
        ...
        success("rect").to(function () {
          return AST.Modifier.Shape.Rect();
        })
      );
    }),
    // <frame_shape> ::= 'F' <frame_main> ( ':' ( <frame_radius_vector> | <color_name> ))*
    ...
    direction: memo(function () {
      return seq(p.direction0, rep(p.direction1)).to(function (
      drs) {
    ...
    direction2: memo(function () {
      return or(
        ...
        lit('q').andr(flit('{')).andr(p.posDecor).andl(flit('}'))
        .to(function (pd) {
    ...
    nonemptyDiag: memo(function () {
      return or(
        regexLit(/^(ld|dl)/).to(function (x) {
          return AST.Diag.LD();
        }),
        regexLit(/^(rd|dr)/).to(function (x) {
          return AST.Diag.RD();
        }),
        regexLit(/^(lu|ul)/).to(function (x) {
          return AST.Diag.LU();
        }),
        regexLit(/^(ru|ur)/).to(function (x) {
          return AST.Diag.RU();
        }),
        lit('l').to(function (x) {
          return AST.Diag.L();
    ...
    command: memo(function () {
      return or(
        lit("\\ar").andr(fun(rep(p.arrowForm))).and(p.path).to(
          function (fsp) {
        ...
        lit("\\afterPATH").andr(flit('{')).andr(p.decor).andl(
          flit('}')).and(p.path).to(function (dp) {
        ...
        lit("\\afterPOS").andr(flit('{')).andr(p.decor).andl(flit(
          '}')).and(p.pos).to(function (dp) {
        ...
        lit("\\xyignore").andr(flit('{')).andr(p.pos).and(p.decor)
        .andl(flit('}')).to(function (pd) {
          return AST.Command.Ignore(pd.head, pd.tail);
        }),
        lit("\\xyshowAST").andr(flit('{')).andr(p.pos).and(p
          .decor).andl(flit('}')).to(function (pd) {
    ...
    arrowForm: memo(function () {
      return or(
        lit("@").andr(fun(regex(/^([\-\.~=:])/))).to(function (
        c) {
        ...
        lit("@").andr(flit("/")).andr(p.direction).and(fun(opt(p
          .looseDimen))).andl(flit("/")).to(function (dd) {
          return AST.Command.Ar.Form.CurveArrow(dd.head, dd.tail
            .getOrElse(".5pc"));
        }),
        lit("@").andr(flit("(")).andr(p.direction).andl(flit(","))
        .and(p.direction).andl(flit(")")).to(function (dd) {
          return AST.Command.Ar.Form.CurveFitToDirection(dd
            .head, dd.tail);
        }),
        lit("@").andr(flit("`")).andr(p.coord).to(function (c) {
          return AST.Command.Ar.Form.CurveWithControlPoints(c);
        }),
        lit("@").andr(flit("[")).andr(p.shape).andl(flit("]")).to(
          function (s) {
            return AST.Command.Ar.Form.AddShape(s);
          }),
        lit("@").andr(flit("*")).andr(flit("{")).andr(fun(rep(p
          .modifier))).andl(flit("}")).to(function (ms) {
          return AST.Command.Ar.Form.AddModifiers(ms);
        }),
        lit("@").andr(flit("<")).andr(p.dimen).andl(flit(">")).to(
          function (d) {
        ...
        lit("^").andr(p.anchor).and(p.it).to(function (ai) {
          return AST.Command.Ar.Form.LabelAbove(ai.head, ai
            .tail);
        }),
        lit("_").andr(p.anchor).and(p.it).to(function (ai) {
          return AST.Command.Ar.Form.LabelBelow(ai.head, ai
            .tail);
        }),
        lit("@").andr(flit("?")).to(function () {
          return AST.Command.Ar.Form.ReverseAboveAndBelow();
        }),
        lit("@").andr(fun(regex(/^([\^_0123])/).opt())).and(fun(
          opt(p.tipConnTip))).to(function (vtct) {
          var variant = vtct.head.getOrElse("");
          if (vtct.tail.isDefined) {
            var tct = vtct.tail.get;
            return AST.Command.Ar.Form.BuildArrow(variant, tct
              .tail, tct.stem, tct.head);
          } else {
    ...
    tipConnTip: memo(function () {
      return lit("{").andr(fun(opt(p.nonemptyTip))).and(fun(opt(p
        .nonemptyConn))).and(fun(opt(p.nonemptyTip))).andl(flit(
        "}")).to(function (pcp) {
        ...
        if (!maybeStem.isDefined && !maybeHead.isDefined) {
          ...
          stem = maybeStem.getOrElse(AST.Command.Ar.Form.Conn
            .Connchars(""));
    ...
    // <path> ::= <path2>(Nil)
    path: memo(function () {
      return p.path2(FP.List
        .empty /* initial failure continuation */ ).to(function (
        ps) {
    ...
    path2: function (fc) {
      ...
      return or(
        ...
        p.segment().to(function (s) {
          return FP.List.empty.prepend(AST.Command.Path
            .LastSegment(s));
        }),
    ...
    path3: memo(function () {
      return or(
        ...
        seq('~', '<', '{', p.labels, '}').to(function (ls) {
          return AST.Command.Path.AddLabelNextSegmentOnly(ls
            .head.tail);
        }),
        seq('~', '>', '{', p.labels, '}').to(function (ls) {
          return AST.Command.Path.AddLabelLastSegmentOnly(ls
            .head.tail);
        }),
        seq('~', '+', '{', p.labels, '}').to(function (ls) {
          return AST.Command.Path.AddLabelEverySegment(ls.head
            .tail);
        }),
        ...
        seq('`', p.turn, p.segment).to(function (ts) {
          return AST.Command.Path.TurningSegment(ts.head.tail,
            ts.tail);
        })
      );
    }),
    ...
    segment: memo(function () {
      return p.nonemptyPos().and(p.pathSlide).and(p.labels).to(
        function (psl) {
          return AST.Command.Path.Segment(psl.head.head, psl.head
            .tail, psl.tail);
        });
    }),
    // <slide> ::= '<' <dimen> '>'
    ...
    label: memo(function () {
      return or(
        seq('^', p.anchor, p.it, p.alias).to(function (aia) {
          return AST.Command.Path.Label.Above(AST.Pos.Place(aia
            .head.head.tail), aia.head.tail, aia.tail);
        }),
        seq('_', p.anchor, p.it, p.alias).to(function (aia) {
          return AST.Command.Path.Label.Below(AST.Pos.Place(aia
            .head.head.tail), aia.head.tail, aia.tail);
        }),
        seq('|', p.anchor, p.it, p.alias).to(function (aia) {
          return AST.Command.Path.Label.At(AST.Pos.Place(aia
            .head.head.tail), aia.head.tail, aia.tail);
        })
      );
    }),
    ...
    anchor: memo(function () {
      return or(
        lit('-').andr(p.anchor).to(function (a) {
          return AST.Place(1, 1, AST.Place.Factor(0.5),
            undefined).compound(a);
        }),
        p.place
      );
    }),
    // <it> ::= ( '[' <shape> ']' )* <it2>
    it: memo(function () {
      return rep(lit('[').andr(p.shape).andl(flit(']')).to(
        function (s) {
          return s;
        })).and(p.it2).to(function (si) {
        return AST.Object(si.head.concat(si.tail.modifiers), si
          .tail.object);
      });
    }),
    // <it2> ::= <digit> | <letter>
    ...
    it2: memo(function () {
      return or(
        regexLit(/^[0-9a-zA-Z]/).to(function (c) {
          return AST.Object(FP.List.empty, p.toMath(
            "\\labelstyle " + c));
        }),
    ...
    xymatrix: memo(function () {
      return p.setup().andl(flit("{")).and(p.rows).andl(flit("}"))
        .to(function (sr) {
    ...
    setup: memo(function () {
      return rep(fun(or(
        lit('"').andr(fun(regex(/^[^"]+/))).andl(felem('"'))
        .to(function (p) {
          return AST.Command.Xymatrix.Setup.Prefix(p);
        }),
        lit("@!").andr(fun(regex(/^[RC]/).opt().to(function (
          c) {
          return c.getOrElse("");
        }))).and(fun(
          or(
          ...
          switch (cd.head) {
          case "R":
            return AST.Command.Xymatrix.Setup
              .PretendEntrySize.Height(dimen);
          case "C":
            return AST.Command.Xymatrix.Setup
              .PretendEntrySize.Width(dimen);
          default:
            return AST.Command.Xymatrix.Setup
              .PretendEntrySize.HeightAndWidth(dimen);
          }
        }),
        lit("@!").andr(fun(
          or(
            elem("R").to(function () {
              return AST.Command.Xymatrix.Setup.FixGrid
                .Row();
            }),
            elem("C").to(function () {
              return AST.Command.Xymatrix.Setup.FixGrid
            ...
            return rc.getOrElse(AST.Command.Xymatrix.Setup
              .FixGrid.RowAndColumn());
          })
        )),
        lit("@").andr(fun(regex(/^[MWHL]/))).and(p.addOp).and(
          p.dimen).to(function (cod) {
          var addop = cod.head.tail;
          var dimen = cod.tail;
          switch (cod.head.head) {
          case "M":
            return AST.Command.Xymatrix.Setup
              .AdjustEntrySize.Margin(addop, dimen);
          case "W":
            return AST.Command.Xymatrix.Setup
              .AdjustEntrySize.Width(addop, dimen);
          case "H":
            return AST.Command.Xymatrix.Setup
              .AdjustEntrySize.Height(addop, dimen);
          case "L":
            return AST.Command.Xymatrix.Setup
              .AdjustLabelSep(addop, dimen);
          }
        }),
        lit("@").andr(p.nonemptyDirection).to(function (d) {
          return AST.Command.Xymatrix.Setup.SetOrientation(
            d);
        }),
        lit("@*[").andr(p.shape).andl(flit("]")).to(function (
          s) {
          return AST.Command.Xymatrix.Setup.AddModifier(s);
        }),
        lit("@*").andr(p.addOp).and(p.size).to(function (os) {
          return AST.Command.Xymatrix.Setup.AddModifier(AST
            .Modifier.AddOp(os.head, os.tail));
        }),
        lit("@").andr(fun(regex(/^[RC]/).opt().to(function (
        c) {
          return c.getOrElse("");
          ...
          switch (cod.head.head) {
          case "R":
            return AST.Command.Xymatrix.Setup.ChangeSpacing
              .Row(addop, dimen);
          case "C":
            return AST.Command.Xymatrix.Setup.ChangeSpacing
              .Column(addop, dimen);
          default:
            return AST.Command.Xymatrix.Setup.ChangeSpacing
              .RowAndColumn(addop, dimen);
          }
        }),
        lit("@1").to(function () {
          return AST.Command.Xymatrix.Setup.AdjustEntrySize
            .Margin(AST.Modifier.AddOp.Set(), "1pc");
        })
      )));
    }),
    // <rows> ::= <row> ( '\\' <row> )*
    rows: memo(function () {
      return p.row().and(fun(rep(lit("\\\\").andr(p.row)))).to(
        function (rrs) {
          var rows = rrs.tail.prepend(rrs.head);
          if (!rows.isEmpty) {
            var lastRow = rows.at(rows.length() - 1);
            if (lastRow.entries.length() === 1 && lastRow.entries
              .at(0).isEmpty) {
    ...
    // <row> ::= <entry> ( '&' <entry> )*
    row: memo(function () {
      return p.entry().and(fun(rep(lit("&").andr(p.entry)))).to(
        function (ees) {
          return AST.Command.Xymatrix.Row(ees.tail.prepend(ees
            .head));
        })
    }),
    ...
    entry: memo(function () {
      return or(
        lit("*").andr(p.object).and(p.pos).and(p.decor).to(
          function (opd) {
            var obj = opd.head.head;
            var pos = opd.head.tail;
            var decor = opd.tail;
            return AST.Command.Xymatrix.Entry.ObjectEntry(obj,
              pos, decor);
          }),
        p.entryModifier().rep().and(p.looseObjectbox).and(p.decor)
        .to(function (mopd) {
          var modifiers = mopd.head.head.foldLeft(FP.List.empty,
            function (tmpMs, ms) {
          ...
          return AST.Command.Xymatrix.Entry.SimpleEntry(
            modifiers, objbox, decor);
        })
      );
    }),
    ...
    entryModifier: memo(function () {
      return or(
        ...
        lit("**").andr(flit("{")).andr(fun(rep(p.modifier))).andl(
          flit("}"))
      );
    }),
    // <loose objectbox> ::= <objectbox>
        ...
        regex(/^[^\\{}%&]+/).opt().to(function (rs) {
          ...
          rep(
            or(
              ...
              elem("\\").andr(fun(
                not(regex(
                  /^(\\|ar|xymatrix|PATH|afterPATH|save|restore|POS|afterPOS|drop|connect|xyignore|([lrud]+(twocell|uppertwocell|lowertwocell|compositemap))|xtwocell|xuppertwocell|xlowertwocell|xcompositemap)/
                  ))
              )).andr(fun(
                regex(/^[{}%&]/).opt().to(function (c) {
                  return c.getOrElse("");
                })
              )).to(function (t) {
                return "\\" + t;
          ...
          var object = p.toMath("\\hbox{$\\objectstyle{" +
            text + "}$}");
          return {
            isEmpty: isEmpty,
            object: object
    ...
    twocellCommand: memo(function () {
      return p.twocell().and(fun(rep(p.twocellSwitch))).and(p
        .twocellArrow).to(function (tsa) {
        return AST.Command.Twocell(tsa.head.head, tsa.head.tail,
          tsa.tail);
      });
    }),
    // <twocell> ::= '\' /[lrud]+/ 'twocell'
    ...
    twocell: memo(function () {
      return or(
        regexLit(/^\\[lrud]+twocell/).to(function (h) {
          var hops = h.substring(1, h.length - "twocell"
          .length);
          return AST.Command.Twocell.Twocell(hops, FP.Option
            .empty);
        }),
        regexLit(/^\\[lrud]+uppertwocell/).to(function (h) {
          var hops = h.substring(1, h.length - "uppertwocell"
            .length);
          return AST.Command.Twocell.UpperTwocell(hops, FP
            .Option.empty);
        }),
        regexLit(/^\\[lrud]+lowertwocell/).to(function (h) {
          var hops = h.substring(1, h.length - "lowertwocell"
            .length);
          return AST.Command.Twocell.LowerTwocell(hops, FP
            .Option.empty);
        }),
        regexLit(/^\\[lrud]+compositemap/).to(function (h) {
          var hops = h.substring(1, h.length - "compositemap"
            .length);
          return AST.Command.Twocell.CompositeMap(hops, FP
            .Option.empty);
        }),
        or(
          lit("\\xtwocell").to(function () {
            return AST.Command.Twocell.Twocell;
          }),
          lit("\\xuppertwocell").to(function () {
            return AST.Command.Twocell.UpperTwocell;
          }),
          lit("\\xlowertwocell").to(function () {
            return AST.Command.Twocell.LowerTwocell;
          }),
          lit("\\xcompositemap").to(function () {
            return AST.Command.Twocell.CompositeMap;
          })
        ).andl(flit("[")).and(fun(regex(/^[lrud]+/))).andl(flit(
          "]")).andl(flit("{")).and(p.text).andl(flit("}")).to(
          function (cht) {
            var textObject = AST.Object(FP.List.empty, p.toMath(
              "\\labelstyle " + cht.tail));
            return cht.head.head(cht.head.tail, FP.Option.Some(
              textObject));
          })
      );
    }),
    ...
    twocellSwitch: memo(function () {
      return or(
        ...
        lit("\\omit").to(function () {
          return AST.Command.Twocell.Switch
            .DoNotSetCurvedArrows();
        }),
        lit("~!").to(function () {
          return AST.Command.Twocell.Switch.PlaceModMapObject();
        }),
        regexLit(/^(~[`'])/).andl(flit("{")).and(p.object).andl(
          flit("}")).to(function (wo) {
          var what = wo.head.substring(1);
          return AST.Command.Twocell.Switch
            .ChangeHeadTailObject(what, wo.tail);
        }),
        regexLit(/^(~[\^_]?)/).andl(flit("{")).and(p.object).and(
          fun(opt(lit("~**").andr(p.object)))).andl(flit("}")).to(
          function (wso) {
            var what = wso.head.head.substring(1);
            var spacer = wso.head.tail;
            var maybeObject = wso.tail;
            return AST.Command.Twocell.Switch.ChangeCurveObject(
              what, spacer, maybeObject);
          }),
    ...
    twocellLabel: memo(function () {
      return or(
        regexLit(/^[0-9a-zA-Z]/).to(function (c) {
          var obj = AST.Object(FP.List.empty, p.toMath(
            "\\twocellstyle " + c));
          return AST.Command.Twocell.Label(FP.Option.empty,
          obj);
        }),
        regexLit(/^(\\[a-zA-Z][a-zA-Z0-9]*)/).to(function (c) {
          var obj = AST.Object(FP.List.empty, p.toMath(
        ...
        lit("{").andr(fun(opt(p.nudge))).andl(flit("*")).and(p
          .object).andl(flit("}")).to(function (no) {
          return AST.Command.Twocell.Label(no.head, no.tail);
        }),
        lit("{").andr(fun(opt(p.nudge))).and(p.text).andl(felem(
          "}")).to(function (nt) {
          var obj = AST.Object(FP.List.empty, p.toMath(
            "\\twocellstyle " + nt.tail));
    ...
    twocellArrow: memo(function () {
      return or(
        lit("{").andr(fun(regexLit(/^([\^_=`'"!]|\\omit)/))).and(p
          .twocellLabelEntry).andl(flit("}")).to(function (te) {
          return AST.Command.Twocell.Arrow.WithOrientation(te
            .head, te.tail);
        }),
        lit("{").andr(p.nudge).and(p.twocellLabelEntry).andl(flit(
          "}")).to(function (te) {
          return AST.Command.Twocell.Arrow.WithPosition(te.head,
            te.tail);
        }),
        lit("{").andr(p.twocellLabelEntry).andl(flit("}")).to(
          function (e) {
            return AST.Command.Twocell.Arrow.WithOrientation('',
              e);
          }),
        success("no arrow label").to(function () {
          // TODO 無駄な空描画処理をなくす。
          return AST.Command.Twocell.Arrow.WithOrientation('',
            AST.Object(FP.List.empty, p.toMath(
              "\\twocellstyle{}")));
        })
      );
    }),
    ...
    newdir: memo(function () {
      return lit("{").andr(p.dirMain).andl(felem("}")).andl(flit(
        "{")).and(p.compositeObject).andl(flit("}")).to(function (
        mc) {
        return AST.Command.Newdir(mc.head, AST.ObjectBox
          .CompositeObject(mc.tail));
      });
    }),
    // '\xyimport' '(' <factor> ',' <factor> ')' ( '(' <factor> ',' <factor> ')' )? '{' ( <include graphics> | <TeX command> ) '}'
    xyimport: memo(function () {
      return lit("\\xyimport").andr(flit("(")).andr(p.factor).andl(
        flit(",")).and(p.factor).andl(flit(")")).and(fun(
        opt(lit("(").andr(p.factor).andl(flit(",")).and(p
          .factor).andl(flit(")")))
      )).andl(flit("{")).and(fun(
        or(
          lit("\\includegraphics").andr(p.includegraphics),
          p.text().to(function (t) {
            return p.toMath("\\hbox{$\\objectstyle{" + t +
              "}$}");
          })
        ...
        if (graphics.isIncludegraphics !== undefined) {
          return AST.Pos.Xyimport.Graphics(w, h, xOffset,
            yOffset, graphics);
        } else {
          return AST.Pos.Xyimport.TeXCommand(w, h, xOffset,
            yOffset, graphics);
        }
      });
    }),
    ...
    includegraphics: memo(function () {
      return lit("[").andr(fun(opt(p.includegraphicsAttrList)))
        .andl(flit("]")).andl(flit("{")).and(fun(regexLit(
          /^[^\s{}]+/))).andl(flit("}")).to(function (af) {
          var attrList = af.head.getOrElse(FP.List.empty);
          var file = af.tail;
          return AST.Command.Includegraphics(false, attrList,
            file);
        });
    }),
    // <includegraphics attr list> := <includegraphics attr key val> ( ',' <includegraphics attr key val> )*
    includegraphicsAttrList: memo(function () {
      return p.includegraphicsAttr().and(fun(rep(lit(",").andr(p
        .includegraphicsAttr)))).to(function (aas) {
    ...
    includegraphicsAttr: memo(function () {
      return or(
        lit("width").andr(flit("=")).andr(p.dimen).to(function (
        d) {
          return AST.Command.Includegraphics.Attr.Width(d);
        }),
        lit("height").andr(flit("=")).andr(p.dimen).to(function (
          d) {
  ...
  xypic.ParseError = MathJax.Object.Subclass({
    ...
    toMML: function () {
      ...
      return MML.merror(MML.mtext('parse error at or near "' +
        lineContents + '"'));
      /*
      var col = pos.column();
  ...
  MathJax.Hub.Browser.Select({
    ...
    MSIE: function (browser) {
      if (MathJax.Hub.Browser.versionAtLeast("9.0") && document
        .documentMode >= 9) {
        supportGraphics = true;
      }
    }
...
MathJax.Hub.Register.StartupHook("Device-Independent Xy-pic Require",
function () {
  var FP = MathJax.Extension.fp;
  var MML = MathJax.ElementJax.mml;
  var HUB = MathJax.Hub;
  ...
  xypic.ModifierRepository = MathJax.Object.Subclass({
    ...
    get: function (shapeName) {
      var modifier = xypic.ModifierRepository.embeddedModifierMap[
        shapeName];
    ...
    put: function (shapeName, modifier) {
      if (xypic.ModifierRepository.embeddedModifierMap[shapeName] ===
        undefined) {
    ...
    embeddedModifierMap: {
      ...
      "blanchedalmond": AST.Modifier.Shape.ChangeColor(
        "blanchedalmond"),
      ...
      "cornflowerblue": AST.Modifier.Shape.ChangeColor(
        "cornflowerblue"),
      ...
      "darkolivegreen": AST.Modifier.Shape.ChangeColor(
        "darkolivegreen"),
      ...
      "lightgoldenrodyellow": AST.Modifier.Shape.ChangeColor(
      ...
      "lightslategray": AST.Modifier.Shape.ChangeColor(
        "lightslategray"),
      "lightslategrey": AST.Modifier.Shape.ChangeColor(
        "lightslategrey"),
      "lightsteelblue": AST.Modifier.Shape.ChangeColor(
        "lightsteelblue"),
      ...
      "mediumaquamarine": AST.Modifier.Shape.ChangeColor(
        "mediumaquamarine"),
      ...
      "mediumseagreen": AST.Modifier.Shape.ChangeColor(
        "mediumseagreen"),
      "mediumslateblue": AST.Modifier.Shape.ChangeColor(
        "mediumslateblue"),
      "mediumspringgreen": AST.Modifier.Shape.ChangeColor(
        "mediumspringgreen"),
      "mediumturquoise": AST.Modifier.Shape.ChangeColor(
        "mediumturquoise"),
      "mediumvioletred": AST.Modifier.Shape.ChangeColor(
        "mediumvioletred"),
  ...
  xypic.Graphics.SVG.World = xypic.Graphics.SVG.Subclass({
    ...
    extendBoundingBox: function (boundingBox) {
      this.boundingBox = xypic.Frame.combineRect(this.boundingBox,
        boundingBox);
    },
    getOrigin: function () {
      return {
  ...
  xypic.Graphics.SVG.Transform = MathJax.Object.Subclass({
    ...
    translate: function (x, y) {
      return xypic.Graphics.SVG.Transform(
        this.transform.append(xypic.Graphics.SVG.Transform
          .Translate(x, y))
      );
    },
    rotateDegree: function (degree) {
      return xypic.Graphics.SVG.Transform(
        this.transform.append(xypic.Graphics.SVG.Transform.Rotate(
          degree / 180 * Math.PI))
      );
    },
    ...
    toString: function () {
      var form = "";
      this.transform.foreach(function (tr) {
        form += tr.toTranslateForm()
      });
      return form;
    },
    apply: function (x, y) {
  ...
  xypic.Graphics.SVG.Transform.Translate = MathJax.Object.Subclass({
    ...
    toTranslateForm: function () {
      return "translate(" + xypic.em2px(this.dx) + "," + xypic.em2px(-
        this.dy) + ") ";
    }
  });
  ...
  xypic.Graphics.Augment({}, {
    createSVG: function (height, depth, width, strokeWidth, color,
    def) {
      return xypic.Graphics.SVG.World(height, depth, width,
        strokeWidth, color, def);
    }
  });
  xypic.DrawingContext = MathJax.Object.Subclass({
    ...
    appendShapeToFront: function (shape) {
      if (shape.isNone) {} else if (this.shape.isNone) {
        this.shape = shape;
      } else {
  ...
  xypic.Util = MathJax.Object.Subclass({}, {
    extProd: function (v1, v2) {
      return [v1[1] * v2[2] - v1[2] * v2[1], v1[2] * v2[0] - v1[0] *
  ...
  HUB.Browser.Select({
    MSIE: function (browser) {
      if (HUB.Browser.versionAtLeast("9.0") && document
        .documentMode >= 9) {
        xypic.useSVG = true;
      }
    },
  ...
  xypic.Frame = MathJax.Object.Subclass({
    ...
    combineRect: function (frame1, frame2) {
      if (frame1 === undefined) {
        ...
        var l = -(Math.min(frame1.x - frame1.l, frame2.x - frame2.l) -
          frame1.x);
        var r = Math.max(frame1.x + frame1.r, frame2.x + frame2.r) -
          frame1.x;
        var d = -(Math.min(frame1.y - frame1.d, frame2.y - frame2.d) -
          frame1.y);
        var u = Math.max(frame1.y + frame1.u, frame2.y + frame2.u) -
          frame1.y;
        return frame1.toRect({
          l: l,
          r: r,
          d: d,
          u: u
  ...
  xypic.Frame.Rect = xypic.Frame.Subclass({
    ...
    isPoint: function () {
      return this.l === 0 && this.r === 0 && this.u === 0 && this
        .d === 0;
    },
    isRect: function () {
      return !this.isPoint();
    ...
    edgePoint: function (x, y) {
      ...
      if (dx > 0) {
        var ey = dy * this.r / dx;
        if (ey > this.u) {
          return xypic.Frame.Point(this.x + this.u * dx / dy, this.y +
            this.u);
        } else if (ey < -this.d) {
          return xypic.Frame.Point(this.x - this.d * dx / dy, this.y -
            this.d);
        }
    ...
    proportionalEdgePoint: function (x, y) {
      ...
      var dx = x - this.x;
      var dy = y - this.y;
      if (Math.abs(dx) < AST.xypic.machinePrecision && Math.abs(dy) <
        AST.xypic.machinePrecision) {
      ...
      if (-3 * pi / 4 < angle && angle <= -pi / 4) {
        // d
        f = (angle + 3 * pi / 4) / (pi / 2);
        return xypic.Frame.Point(this.x + this.r - f * w, this.y +
          this.u);
        ...
        // u
        f = (angle - pi / 4) / (pi / 2);
        return xypic.Frame.Point(this.x - this.l + f * w, this.y -
          this.d);
      } else {
        // l
        f = (angle - (angle > 0 ? 3 * pi / 4 : -5 * pi / 4)) / (pi /
          2);
        return xypic.Frame.Point(this.x + this.r, this.y - this.d +
          f * h);
      }
    },
    grow: function (xMargin, yMargin) {
    ...
    contains: function (point) {
      var x = point.x;
      var y = point.y;
      return (x >= this.x - this.l) && (x <= this.x + this.r) && (y >=
        this.y - this.d) && (y <= this.y + this.u);
    },
    toString: function () {
      return "{x:" + this.x + ", y:" + this.y + ", l:" + this.l +
        ", r:" + this.r + ", u:" + this.u + ", d:" + this.d + "}";
    }
  });
  xypic.Frame.Ellipse = xypic.Frame.Subclass({
    ...
    isPoint: function () {
      return this.r === 0 && this.l === 0 || this.u === 0 && this
        .d === 0;
    },
    isRect: function () {
      return false;
    ...
    isPerfectCircle: function () {
      return this.l === this.r && this.l === this.u && this.l === this
        .d;
    },
    edgePoint: function (x, y) {
      if (this.isPoint()) {
      ...
      if (this.isPerfectCircle()) {
        ...
        var dy = y - this.y;
        var angle;
        if (Math.abs(dx) < AST.xypic.machinePrecision && Math.abs(
          dy) < AST.xypic.machinePrecision) {
          angle = -Math.PI / 2;
        } else {
          angle = Math.atan2(dy, dx);
        }
        return xypic.Frame.Point(this.x + this.r * Math.cos(angle),
        ...
        if (sign(xp0 - cx) === sign(x - cx) && sign(yp0 - cy) ===
          sign(y - cy)) {
    ...
    move: function (x, y) {
      return xypic.Frame.Ellipse(x, y, this.l, this.r, this.u, this
      .d);
    },
    shiftFrame: function (dx, dy) {
  ...
  xypic.Shape.TranslateShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      var g = svg.createGroup(svg.transformBuilder().translate(this
        .dx, this.dy));
      this.shape.draw(g);
    },
    getBoundingBox: function () {
      ...
      return xypic.Frame.Rect(bbox.x + this.dx, bbox.y + this.dy,
        bbox);
    },
    toString: function () {
      return "TranslateShape[dx:" + this.dx + ", dy:" + this.dy +
  ...
  xypic.Shape.CompositeShape = xypic.Shape.Subclass({
    ...
    getBoundingBox: function () {
      return xypic.Frame.combineRect(this.foregroundShape
        .getBoundingBox(), this.backgroundShape.getBoundingBox());
    },
    toString: function () {
      return "(" + this.foregroundShape.toString() + ", " + this
        .backgroundShape.toString() + ")";
    }
  });
  ...
  xypic.Shape.CircleSegmentShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      svg.createSVGElement("path", {
        d: "M" + xypic.em2px(this.sx) + "," + xypic.em2px(-this
            .sy) + " A" + xypic.em2px(this.r) + "," + xypic.em2px(
            this.r) + " 0 " + this.large + "," + this.flip + " " +
          xypic.em2px(this.ex) + "," + xypic.em2px(-this.ey)
      });
    },
    getBoundingBox: function () {
      return xypic.Frame.Ellipse(this.x, this.y, this.r, this.r, this
        .r, this.r);
    },
    toString: function () {
      return "CircleSegmentShape[x:" + this.x + ", y:" + this.y +
        ", sx:" + this.sx + ", sy:" + this.sy + ", r:" + this.r +
        ", large:" + this.large + ", flip:" + this.flip + ", ex:" +
        this.ex + ", ey:" + this.ey + "]";
    }
  });
  xypic.Shape.FullCircleShape = xypic.Shape.Subclass({
    ...
    toString: function () {
      return "FullCircleShape[x:" + this.x + ", y:" + this.y +
        ", r:" + this.r + "]";
    }
  });
  xypic.Shape.RectangleShape = xypic.Shape.Subclass({
    Init: function (x, y, left, right, up, down, r, isDoubled, color,
      dasharray, fillColor, hideLine) {
      this.x = x;
      this.y = y;
      this.left = left;
      this.right = right;
    ...
    draw: function (svg) {
      ...
      if (this.isDoubled) {
        def = {
          ...
          width: xypic.em2px(this.left + this.right - 2 * AST.xypic
            .thickness),
          height: xypic.em2px(this.up + this.down - 2 * AST.xypic
            .thickness),
    ...
    toString: function () {
      return "RectangleShape[x:" + this.x + ", y:" + this.y +
        ", left:" + this.left + ", right:" + this.right + ", up:" +
        this.up + ", down:" + this.down + ", r:" + this.r +
        ", isDouble:" + this.isDouble + ", dasharray:" + this
        .dasharray + "]";
    }
  });
  xypic.Shape.EllipseShape = xypic.Shape.Subclass({
    Init: function (x, y, rx, ry, isDoubled, color, dasharray,
      fillColor, hideLine) {
      this.x = x;
      this.y = y;
      this.rx = rx;
    ...
    toString: function () {
      return "EllipseShape[x:" + this.x + ", y:" + this.y + ", rx:" +
        this.rx + ", ry:" + this.ry + ", isDoubled:" + this
        .isDoubled + ", dasharray:" + this.dasharray + "]";
    }
  });
  xypic.Shape.BoxShadeShape = xypic.Shape.Subclass({
    ...
    toString: function () {
      return "RectangleShape[x:" + this.x + ", y:" + this.y +
        ", left:" + this.left + ", right:" + this.right + ", up:" +
        this.up + ", down:" + this.down + ", depth:" + this.depth +
        "]";
    }
  });
  xypic.Shape.LeftBrace = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      ...
      var down = Math.max(0.759375 + 0.660375, this.down / scale *
        1.125) - 0.660375;
      var up = -Math.max(0.759375 + 0.660375, this.up / scale *
        1.125) + 0.660375;
      var d;
      d = "M" + xypic.em2px(-0.0675) + " " + xypic.em2px(down) +
        "T" + xypic.em2px(-0.068625) + " " + xypic.em2px(0.07875 +
          down) +
        "Q" + xypic.em2px(-0.068625) + " " + xypic.em2px(0.190125 +
          down) +
        " " + xypic.em2px(-0.0585) + " " + xypic.em2px(0.250875 +
          down) +
        "T" + xypic.em2px(-0.01125) + " " + xypic.em2px(0.387 +
        down) +
        "Q" + xypic.em2px(0.07425) + " " + xypic.em2px(0.55575 +
        down) +
        " " + xypic.em2px(0.2475) + " " + xypic.em2px(0.6525 + down) +
        "L" + xypic.em2px(0.262125) + " " + xypic.em2px(0.660375 +
          down) +
        "L" + xypic.em2px(0.3015) + " " + xypic.em2px(0.660375 +
        down) +
        "L" + xypic.em2px(0.30825) + " " + xypic.em2px(0.653625 +
          down) +
        "V" + xypic.em2px(0.622125 + down) +
        "Q" + xypic.em2px(0.30825) + " " + xypic.em2px(0.60975 +
        down) +
        " " + xypic.em2px(0.2925) + " " + xypic.em2px(0.60075 +
        down) +
        "Q" + xypic.em2px(0.205875) + " " + xypic.em2px(0.541125 +
          down) +
        " " + xypic.em2px(0.149625) + " " + xypic.em2px(0.44775 +
          down) +
        "T" + xypic.em2px(0.07425) + " " + xypic.em2px(0.239625 +
          down) +
        "Q" + xypic.em2px(0.07425) + " " + xypic.em2px(0.2385 +
        down) +
        " " + xypic.em2px(0.073125) + " " + xypic.em2px(0.235125 +
          down) +
        "Q" + xypic.em2px(0.068625) + " " + xypic.em2px(0.203625 +
          down) +
        " " + xypic.em2px(0.0675) + " " + xypic.em2px(0.041625 +
        down) +
        ...
        "L" + xypic.em2px(0.0675) + " " + xypic.em2px(-0.041625 +
        up) +
        "Q" + xypic.em2px(0.068625) + " " + xypic.em2px(-0.203625 +
          up) +
        " " + xypic.em2px(0.073125) + " " + xypic.em2px(-0.235125 +
        ...
        " " + xypic.em2px(0.07425) + " " + xypic.em2px(-0.239625 +
        up) +
        "Q" + xypic.em2px(0.093375) + " " + xypic.em2px(-0.354375 +
          up) +
        " " + xypic.em2px(0.149625) + " " + xypic.em2px(-0.44775 +
        up) +
        ...
        "Q" + xypic.em2px(0.30825) + " " + xypic.em2px(-0.60975 +
        up) +
        " " + xypic.em2px(0.30825) + " " + xypic.em2px(-0.622125 +
        up) +
        "L" + xypic.em2px(0.30825) + " " + xypic.em2px(-0.653625 +
        up) +
        "L" + xypic.em2px(0.3015) + " " + xypic.em2px(-0.660375 +
        ...
        "Q" + xypic.em2px(-0.048375) + " " + xypic.em2px(-0.311625 +
          up) +
        " " + xypic.em2px(-0.0585) + " " + xypic.em2px(-0.250875 +
        up) +
        "T" + xypic.em2px(-0.068625) + " " + xypic.em2px(-0.07875 +
      ...
      svg.createSVGElement("path", {
        ...
        stroke: this.color,
        "stroke-width": "0pt",
        transform: "translate(" + xypic.em2px(this.x) + "," +
          xypic.em2px(-this.y) + ") rotate(" + (-this.degree) +
          ") scale(" + (scale / 1.125) + ")"
      });
    },
    getBoundingBox: function () {
      ...
      return xypic.Frame.Rect(this.x, this.y, {
        l: 0.274 * scale,
        r: 0.274 * scale,
        u: Math.max((0.759375 + 0.660375) * scale / 1.125, this
          .up),
        d: Math.max((0.759375 + 0.660375) * scale / 1.125, this
          .down)
      }).rotate(this.degree * Math.PI / 180);
    },
    toString: function () {
      return "LeftBrace[x:" + this.x + ", y:" + this.y + ", up:" +
  ...
  xypic.Shape.LeftParenthesis = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      var scale = xypic.oneem;
      var down = Math.max(0.660375, this.height / 2 / scale * 1.125) -
        0.660375;
      var up = -down;
      var d;
      d = "M" + xypic.em2px(-0.0675) + " " + xypic.em2px(down) +
    ...
    getBoundingBox: function () {
      ...
      return xypic.Frame.Rect(this.x, this.y, {
        l: 0.06 * scale,
        r: 0.274 * scale,
        u: Math.max(0.660375 * scale / 1.125, this.height / 2),
        d: Math.max(0.660375 * scale / 1.125, this.height / 2)
      }).rotate(this.degree * Math.PI / 180);
    },
    toString: function () {
      return "LeftBrace[x:" + this.x + ", y:" + this.y + ", up:" +
  ...
  xypic.Shape.TextShape = xypic.Shape.Subclass({
    ...
    toString: function () {
      return "TextShape[c:" + this.c.toString() + ", math:" + this
        .math.toString() + "]";
    }
  });
  xypic.Shape.ImageShape = xypic.Shape.Subclass({
    ...
    toString: function () {
      return "ImageShape[c:" + this.c.toString() + ", height:" + this
        .height + ", width:" + this.width + ", url:" + this.url + "]";
    }
  });
  xypic.Shape.ArrowheadShape = xypic.Shape.Subclass({
    draw: function (svg) {
      var g = svg.createGroup(svg.transformBuilder().translate(this.c
        .x, this.c.y).rotateRadian(this.angle));
      this.drawDelegate(g);
    },
    getBoundingBox: function () {
    ...
    toString: function () {
      return "ArrowheadShape[c:" + this.c.toString() + ", angle:" +
        this.angle + "]";
    }
  });
  // @2{>}
  xypic.Shape.GT2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    drawDelegate: function (svg) {
      var scale = xypic.oneem;
      var gu = svg.createGroup(svg.transformBuilder().rotateDegree(-
        10));
      var gd = svg.createGroup(svg.transformBuilder().rotateDegree(
        10));
      gu.createSVGElement("path", {
        d: "M0,0 Q" + xypic.em2px(-0.222 * scale) + "," + xypic
          .em2px(-0.020 * scale) + " " + xypic.em2px(-0.489 *
            scale) + "," + xypic.em2px(-0.147 * scale)
      });
  ...
  // @^{|}
  xypic.Shape.UpperColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{|}
  xypic.Shape.LowerColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  xypic.Shape.Column2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: 0,
        r: 0,
        u: 0.5 * (AST.xypic.lineElementLength + AST.xypic.thickness),
        d: 0.5 * (AST.xypic.lineElementLength + AST.xypic.thickness)
      };
    },
    drawDelegate: function (svg) {
      var l = xypic.em2px(0.5 * (AST.xypic.lineElementLength + AST
        .xypic.thickness));
      svg.createSVGElement("line", {
        x1: 0,
        y1: l,
  ...
  xypic.Shape.ColumnArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: 0,
        r: 0,
        u: 0.5 * AST.xypic.lineElementLength,
        d: 0.5 * AST.xypic.lineElementLength
      };
    },
    drawDelegate: function (svg) {
  ...
  // @^{(}
  xypic.Shape.UpperLParenArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
      ...
      getBox: function () {
        return {
          l: 0.5 * AST.xypic.lineElementLength,
          r: 0,
          u: AST.xypic.lineElementLength,
          d: 0
        };
  ...
  // @_{(}
  xypic.Shape.LowerLParenArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  xypic.Shape.LParenArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: 0,
        r: 0.5 * AST.xypic.lineElementLength,
        u: 0.5 * AST.xypic.lineElementLength,
        d: 0.5 * AST.xypic.lineElementLength
      };
    },
  ...
  // @^{)}
  xypic.Shape.UpperRParenArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{)}
  xypic.Shape.LowerRParenArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{`}
  xypic.Shape.LowerBackquoteArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{`}, @^{`}
  xypic.Shape.UpperBackquoteArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{'}
  xypic.Shape.LowerQuoteArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{'}, @^{'}
  xypic.Shape.UpperQuoteArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  xypic.Shape.AsteriskArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: AST.xypic.thickness,
        r: AST.xypic.thickness,
        u: AST.xypic.thickness,
        d: AST.xypic.thickness
      };
    },
    drawDelegate: function (svg) {
      svg.createSVGElement("circle", {
        cx: 0,
        cy: 0,
        r: xypic.em2px(AST.xypic.thickness),
        fill: "currentColor"
      });
    }
  });
  ...
  xypic.Shape.SlashArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: 0,
        r: 0,
        u: AST.xypic.lineElementLength / 2,
        d: AST.xypic.lineElementLength / 2
      };
    },
    drawDelegate: function (svg) {
      var halfLen = AST.xypic.lineElementLength / 2;
  ...
  xypic.Shape.Line2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: 0,
        r: AST.xypic.lineElementLength,
        u: 0.5 * AST.xypic.thickness,
        d: 0.5 * AST.xypic.thickness
      };
    },
    drawDelegate: function (svg) {
  ...
  xypic.Shape.Tilde3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: -2 * AST.xypic.thickness,
        r: 2 * AST.xypic.thickness,
        u: 2 * AST.xypic.thickness,
        d: 2 * AST.xypic.thickness
      };
    },
    drawDelegate: function (svg) {
  ...
  xypic.Shape.Tilde2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      return {
        l: -2 * AST.xypic.thickness,
        r: 2 * AST.xypic.thickness,
        u: 1.5 * AST.xypic.thickness,
        d: 1.5 * AST.xypic.thickness
      };
    },
    drawDelegate: function (svg) {
      var s = xypic.em2px(AST.xypic.thickness);
  ...
  xypic.Shape.GTGTArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      var scale = xypic.oneem;
      return {
        l: 0.489 * scale + 2 * AST.xypic.thickness,
        r: 0,
        d: 0.147 * scale,
        u: 0.147 * scale
      };
    ...
    drawDelegate: function (svg) {
      ...
      svg.createSVGElement("path", {
        d: "M" + (-hshift) + ",0 Q" + (xypic.em2px(-0.222 *
            scale) - hshift) + "," + xypic.em2px(0.020 * scale) +
          " " + (xypic.em2px(-0.489 * scale) - hshift) + "," +
          xypic.em2px(0.147 * scale)
      });
      svg.createSVGElement("path", {
        d: "M" + (-hshift) + ",0 Q" + (xypic.em2px(-0.222 *
            scale) - hshift) + "," + xypic.em2px(-0.020 * scale) +
  ...
  // @^{>>}
  xypic.Shape.UpperGTGTArrowheadShape = xypic.Shape.ArrowheadShape
.Subclass({
    Init: function (c, angle) {
      this.c = c;
      this.angle = angle;
  ...
  // @_{>>}
  xypic.Shape.LowerGTGTArrowheadShape = xypic.Shape.ArrowheadShape
.Subclass({
    Init: function (c, angle) {
      this.c = c;
      this.angle = angle;
  ...
  xypic.Shape.GTGT2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      var scale = xypic.oneem;
      return {
        l: 0.456 * scale + 2 * AST.xypic.thickness,
        r: 0,
        d: 0.229 * scale,
        u: 0.229 * scale
      };
    ...
    drawDelegate: function (svg) {
      var scale = xypic.oneem;
      var t = AST.xypic.thickness;
      var gu1 = svg.createGroup(svg.transformBuilder().rotateDegree(-
        10));
      var gd1 = svg.createGroup(svg.transformBuilder().rotateDegree(
        10));
      ...
      var gu2 = svg.createGroup(svg.transformBuilder().translate(-2 *
        t, 0).rotateDegree(-10));
      var gd2 = svg.createGroup(svg.transformBuilder().translate(-2 *
        t, 0).rotateDegree(10));
  ...
  xypic.Shape.GTGT3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      var scale = xypic.oneem;
      return {
        l: 0.507 * scale + 2 * AST.xypic.thickness,
        r: 0,
        d: 0.268 * scale,
        u: 0.268 * scale
      };
    ...
    drawDelegate: function (svg) {
      ...
      svg.createSVGElement("line", {
        x1: 0,
        y1: 0,
        x2: xypic.em2px(-0.507 * scale - 2 * t),
        y2: 0
      });
    }
  });
  ...
  xypic.Shape.LTLTArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      ...
      return {
        l: 0,
        r: 0.489 * scale + 2 * AST.xypic.thickness,
        d: 0.147 * scale,
        u: 0.147 * scale
      };
    },
    drawDelegate: function (svg) {
      ...
      var hshift = xypic.em2px(2 * t);
      svg.createSVGElement("path", {
        d: "M" + hshift + ",0 Q" + (xypic.em2px(0.222 * scale) +
            hshift) + "," + xypic.em2px(-0.020 * scale) + " " + (
            xypic.em2px(0.489 * scale) + hshift) + "," + xypic
          .em2px(-0.147 * scale)
      });
      svg.createSVGElement("path", {
        d: "M" + hshift + ",0 Q" + (xypic.em2px(0.222 * scale) +
  ...
  // @^{<<}
  xypic.Shape.UpperLTLTArrowheadShape = xypic.Shape.ArrowheadShape
.Subclass({
    Init: function (c, angle) {
      this.c = c;
      this.angle = angle;
  ...
  // @_{<<}
  xypic.Shape.LowerLTLTArrowheadShape = xypic.Shape.ArrowheadShape
.Subclass({
    Init: function (c, angle) {
      this.c = c;
      this.angle = angle;
  ...
  xypic.Shape.LTLT2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      ...
      return {
        l: 0,
        r: 0.456 + scale + 2 * AST.xypic.thickness,
        d: 0.229 * scale,
        u: 0.229 * scale
      };
    },
    ...
    drawDelegate: function (svg) {
      var scale = xypic.oneem;
      var t = AST.xypic.thickness;
      var gu1 = svg.createGroup(svg.transformBuilder().translate(2 *
        t, 0).rotateDegree(10));
      var gd1 = svg.createGroup(svg.transformBuilder().translate(2 *
        t, 0).rotateDegree(-10));
      gu1.createSVGElement("path", {
        d: "M0,0 Q" + xypic.em2px(0.222 * scale) + "," + xypic
          .em2px(-0.020 * scale) + " " + xypic.em2px(0.489 *
      ...
      var gu2 = svg.createGroup(svg.transformBuilder().rotateDegree(
        10));
      var gd2 = svg.createGroup(svg.transformBuilder().rotateDegree(-
        10));
      gu2.createSVGElement("path", {
        d: "M0,0 Q" + xypic.em2px(0.222 * scale) + "," + xypic
          .em2px(-0.020 * scale) + " " + xypic.em2px(0.489 *
  ...
  xypic.Shape.LTLT3ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    getBox: function () {
      ...
      return {
        l: 0,
        r: 0.507 * scale + 2 * AST.xypic.thickness,
        d: 0.268 * scale,
        u: 0.268 * scale
      };
    },
  ...
  // @{||}
  xypic.Shape.ColumnColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @^{||}
  xypic.Shape.UpperColumnColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{||}
  xypic.Shape.LowerColumnColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @2{||}
  xypic.Shape.ColumnColumn2ArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @3{||}
  xypic.Shape.ColumnColumn3ArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{|-}
  xypic.Shape.ColumnLineArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @^{|-}
  xypic.Shape.UpperColumnLineArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @_{|-}
  xypic.Shape.LowerColumnLineArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @2{|-}
  xypic.Shape.ColumnLine2ArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @3{|-}
  xypic.Shape.ColumnLine3ArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{>>|}
  xypic.Shape.GTGTColumnArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{|<<}
  xypic.Shape.ColumnLTLTArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  // @{//}
  xypic.Shape.SlashSlashArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle - Math.PI / 10;
  ...
  xypic.Shape.LineGT2ArrowheadShape = xypic.Shape.ArrowheadShape.Subclass({
    ...
    drawDelegate: function (svg) {
      ...
      var gu = svg.createGroup(svg.transformBuilder().translate(
        halfLen, 0).rotateDegree(-10));
      var gd = svg.createGroup(svg.transformBuilder().translate(
        halfLen, 0).rotateDegree(10));
      gu.createSVGElement("path", {
        d: "M0,0 Q" + xypic.em2px(-0.222 * scale) + "," + xypic
          .em2px(-0.020 * scale) + " " + xypic.em2px(-0.489 *
      ...
      svg.createSVGElement("path", {
        d: "M" + (-hshift) + "," + vshift + " L" + (hshift -
            delta) + "," + vshift +
          " M" + (-hshift) + "," + (-vshift) + " L" + (hshift -
            delta) + "," + (-vshift)
      });
    }
  });
  // twocell equality arrow
  xypic.Shape.TwocellEqualityArrowheadShape = xypic.Shape.ArrowheadShape
    .Subclass({
      Init: function (c, angle) {
        this.c = c;
        this.angle = angle;
  ...
  xypic.Shape.LineShape = xypic.Shape.Subclass({
    ...
    toString: function () {
      return "LineShape[line:" + this.line + ", object:" + this
        .object + ", main:" + this.main + ", variant:" + this
        .variant + "]";
    }
  });
  xypic.Shape.CurveShape = xypic.Shape.Subclass({
    ...
    draw: function (svg) {
      this.curve.drawCurve(svg, this.objectForDrop, this
        .objectForConnect, this.holeRanges);
    },
    getBoundingBox: function () {
      return this.bbox;
    },
    toString: function () {
      return "CurveShape[curve" + this.curve + ", objectForDrop:" + (
        this.objectForDrop !== undefined ? this.objectForDrop
        .toString() : "null") + ", objectForConnect:" + (this
        .objectForConnect !== undefined ? this.objectForConnect
        .toString() : "null") + "]";
    }
  });
  xypic.Curve = MathJax.Object.Subclass({
    ...
    length: function (t) {
      if (t < 0 || t > 1) {
        throw xypic.ExecutionError(
          "illegal cubic Bezier parameter t:" + t);
      }
    ...
    drawParallelCurve: function (svg, vshift) {
      var i, n = this.countOfSegments() * AST.xypic
      ...
      xypic.Curve.CubicBeziers.interpolation(ts, x1s, y1s)
        .drawPrimitive(svg, "none");
      xypic.Curve.CubicBeziers.interpolation(ts, x2s, y2s)
        .drawPrimitive(svg, "none");
    },
    ...
    drawParallelDashedCurve: function (svg, dash, vshift) {
      var len = this.length(1);
      var n = Math.floor((len - dash) / (2 * dash)),
        m = 2 * n + 1;
    ...
    drawSquigCurve: function (svg, variant) {
      ...
      if (len >= wave) {
        ...
        var s, t, p, angle, nx, ny, hpi = Math.PI / 2,
          d1, d2, d3;
        switch (variant) {
        case "3":
          s = shiftLen;
          ...
          d1 = "M" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p.y -
            ny);
          d2 = "M" + xypic.em2px(p.x) + "," + xypic.em2px(-p.y);
          d3 = "M" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p.y +
            ny);
          for (var i = 0; i < n; i++) {
            ...
            nx = amp * Math.cos(angle + hpi);
            ny = amp * Math.sin(angle + hpi);
            d1 += " Q" + xypic.em2px(p.x + 2 * nx) + "," + xypic
              .em2px(-p.y - 2 * ny);
            d2 += " Q" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            ...
            nx = amp * Math.cos(angle + hpi);
            ny = amp * Math.sin(angle + hpi);
            d1 += " " + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            d2 += " " + xypic.em2px(p.x) + "," + xypic.em2px(-p.y);
            d3 += " " + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            ...
            d2 += " Q" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            d3 += " " + xypic.em2px(p.x - 2 * nx) + "," + xypic.em2px(
              -p.y + 2 * ny);
            s = shiftLen + wave * (i + 1);
            t = this.tOfLength(s);
            p = this.position(t);
        ...
        case "2":
          ...
          d1 = "M" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p.y -
            ny);
          d2 = "M" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p.y +
            ny);
          for (var i = 0; i < n; i++) {
            s = shiftLen + wave * i + thickness;
            t = this.tOfLength(s);
            ...
            nx = amp * Math.cos(angle + hpi) / 2;
            ny = amp * Math.sin(angle + hpi) / 2;
            d1 += " Q" + xypic.em2px(p.x + 3 * nx) + "," + xypic
              .em2px(-p.y - 3 * ny);
            d2 += " Q" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            s = shiftLen + wave * i + 2 * thickness;
            ...
            d1 += " " + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            d2 += " " + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            s = shiftLen + wave * i + 3 * thickness;
            t = this.tOfLength(s);
            p = this.position(t);
            ...
            nx = amp * Math.cos(angle + hpi) / 2;
            ny = amp * Math.sin(angle + hpi) / 2;
            d1 += " Q" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            d2 += " Q" + xypic.em2px(p.x - 3 * nx) + "," + xypic
              .em2px(-p.y + 3 * ny);
            s = shiftLen + wave * (i + 1);
            t = this.tOfLength(s);
            p = this.position(t);
      ...
      if (len >= wave) {
        ...
        case "3":
          ...
          for (var i = 0; i <= n; i++) {
            ...
            nx = amp * Math.cos(angle + hpi);
            ny = amp * Math.sin(angle + hpi);
            d1 += " M" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            d2 += " M" + xypic.em2px(p.x) + "," + xypic.em2px(-p.y);
            d3 += " M" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            s = shiftLen + wave * i * 2 + thickness;
            t = this.tOfLength(s);
            p = this.position(t);
        ...
        case "2":
          ...
          for (var i = 0; i <= n; i++) {
            ...
            d1 += " M" + xypic.em2px(p.x + nx) + "," + xypic.em2px(-p
              .y - ny);
            d2 += " M" + xypic.em2px(p.x - nx) + "," + xypic.em2px(-p
              .y + ny);
            s = shiftLen + wave * i * 2 + thickness;
            t = this.tOfLength(s);
            p = this.position(t);
    ...
    drawCurve: function (svg, objectForDrop, objectForConnect,
      ...
      if (holeRanges.isEmpty) {
        ...
        var clippingRanges = xypic.Range(0, 1).differenceRanges(
          holeRanges);
        var self = this;
        clippingRanges.foreach(function (range) {
          self.slice(range.start, range.end)._drawCurve(svg,
            objectForDrop, objectForConnect);
        });
      }
    },
    _drawCurve: function (svg, objectForDrop, objectForConnect) {
      ...
      if (objectForConnect !== undefined) {
        ...
        case '--':
          ...
          if (len >= dash) {
            ...
            case "3":
              vshift = thickness;
              this.drawParallelDashedCurve(svg, dash, vshift);
              var shiftLen = (len - dash) / 2 - Math.floor((len -
                dash) / 2 / dash) * dash;
              var shiftT = this.tOfLength(shiftLen);
              var shifted = this.divide(shiftT)[1];
              shifted.drawPrimitive(svg, xypic.em2px(dash) + " " +
                xypic.em2px(dash))
              break;
            default:
              vshift = 0;
        ...
        default:
          ...
          var dummyContext = xypic.DrawingContext(xypic.Shape.none,
            dummyEnv);
          ...
          for (var i = 0; i < n; i++) {
            ...
            dummyEnv.c = this.position(t);
            dummyEnv.angle = this.angle(t);
            bbox = objectForConnect.toDropShape(dummyContext).draw(
              svg);
          }
        }
      } else {
        ...
        var shiftLen = (len - n * objectLen + objectLen -
          objectWidth) / 2 + objectBBox.l;
        var dummyContext = xypic.DrawingContext(xypic.Shape.none,
          dummyEnv);
        for (var i = 0; i < n; i++) {
    ...
    toShape: function (context, objectForDrop, objectForConnect) {
      ...
      if (objectForConnect !== undefined) {
        ...
        default:
          ...
          shape = xypic.Shape.CurveShape(this, objectForDrop,
            objectForConnect, this.boundingBox(vshift));
  ...
  xypic.Curve.QuadBezier = xypic.Curve.Subclass({
    ...
    boundingBox: function (vshift) {
      var maxMinX = this.maxMin(this.cp0.x, this.cp1.x, this.cp2.x,
        vshift);
      var maxMinY = this.maxMin(this.cp0.y, this.cp1.y, this.cp2.y,
        vshift);
      if (vshift === 0) {
        return xypic.Frame.Rect(this.cp0.x, this.cp0.y, {
          l: this.cp0.x - maxMinX.min,
          r: maxMinX.max - this.cp0.x,
          u: maxMinY.max - this.cp0.y,
          d: this.cp0.y - maxMinY.min
        });
      } else {
        var hpi = Math.PI / 2;
        var sx = this.cp0.x;
        ...
        var vc0 = vshift * Math.cos(a0),
          vs0 = vshift * Math.sin(a0);
        var vc1 = vshift * Math.cos(a1),
          vs1 = vshift * Math.sin(a1);
        var minX = Math.min(maxMinX.min, sx + vc0, sx - vc0, ex + vc1,
          ex - vc1);
        var maxX = Math.max(maxMinX.max, sx + vc0, sx - vc0, ex + vc1,
          ex - vc1);
        var minY = Math.min(maxMinY.min, sy + vs0, sy - vs0, ey + vs1,
          ey - vs1);
        var maxY = Math.max(maxMinY.max, sy + vs0, sy - vs0, ey + vs1,
          ey - vs1);
    ...
    divide: function (t) {
      if (t < 0 || t > 1) {
        throw xypic.ExecutionError(
          "illegal quadratic Bezier parameter t:" + t);
      }
      var x0 = this.cp0.x;
      var x1 = this.cp1.x;
      var x2 = this.cp2.x;
      ...
      var ty = this.py(t);
      var p0 = this.cp0;
      var p1 = xypic.Frame.Point(x0 + t * (x1 - x0), y0 + t * (y1 -
        y0));
      var p2 = xypic.Frame.Point(tx, ty);
      var q0 = p2;
      var q1 = xypic.Frame.Point(x1 + t * (x2 - x1), y1 + t * (y2 -
        y1));
      var q2 = this.cp2;
      return [
    ...
    slice: function (t0, t1) {
      ...
      var p1 = xypic.Frame.Point(q0x + t1 * (q1x - q0x), q0y + t1 * (
        q1y - q0y));
    ...
    tOfIntersections: function (frame) {
      ...
      if (frame.isRect()) {
        ...
        var ts = [];
        var tsCandidate;
        tsCandidate = xypic.Curve.solutionsOfQuadEq(a2x, a1x, a0x -
          rx);
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfQuadEq(a2x, a1x, a0x - lx));
        ...
        tsCandidate = xypic.Curve.solutionsOfQuadEq(a2y, a1y, a0y -
          uy);
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfQuadEq(a2y, a1y, a0y - dy));
        for (var i = 0; i < tsCandidate.length; i++) {
          var t = tsCandidate[i];
          var x = px(t);
          if (x >= lx && x <= rx) {
        ...
        var arc0 = xypic.CurveSegment.Arc(cx, cy, rx, ry, -pi - delta,
          -pi / 2 + delta);
        var arc1 = xypic.CurveSegment.Arc(cx, cy, rx, ry, -pi / 2 -
          delta, 0 + delta);
        var arc2 = xypic.CurveSegment.Arc(cx, cy, rx, ry, 0 - delta,
          pi / 2 + delta);
        var arc3 = xypic.CurveSegment.Arc(cx, cy, rx, ry, pi / 2 -
          delta, pi + delta);
        var bezier = xypic.CurveSegment.QuadBezier(this, 0, 1);
        var intersec = [];
        intersec = intersec.concat(xypic.CurveSegment
          .findIntersections(arc0, bezier));
        intersec = intersec.concat(xypic.CurveSegment
          .findIntersections(arc1, bezier));
        intersec = intersec.concat(xypic.CurveSegment
          .findIntersections(arc2, bezier));
        intersec = intersec.concat(xypic.CurveSegment
          .findIntersections(arc3, bezier));
        var ts = [];
    ...
    drawPrimitive: function (svg, dasharray) {
      var cp0 = this.cp0,
        ...
        cp2 = this.cp2;
      svg.createSVGElement("path", {
        "d": "M" + xypic.em2px(cp0.x) + "," + xypic.em2px(-cp0
          .y) +
    ...
    toString: function () {
      return "QuadBezier(" + this.cp0.x + ", " + this.cp0.y + ")-(" +
        this.cp1.x + ", " + this.cp1.y + ")-(" + this.cp2.x + ", " +
        this.cp2.y + ")"
    }
  });
  xypic.Curve.CubicBezier = xypic.Curve.Subclass({
    Init: function (cp0, cp1, cp2, cp3) {
      ...
      this.px = function (t) {
        return a0x + t * a1x + t * t * a2x + t * t * t * a3x;
      }
      this.dpx = function (t) {
        return a1x + 2 * t * a2x + 3 * t * t * a3x;
      }
      var a0y = cp0.y;
      ...
      this.py = function (t) {
        return a0y + t * a1y + t * t * a2y + t * t * t * a3y;
      }
      this.dpy = function (t) {
        return a1y + 2 * t * a2y + 3 * t * t * a3y;
      }
    },
    startPosition: function () {
      return this.cp0;
    ...
    maxMin: function (x0, x1, x2, x3, vshift) {
      ...
      var p = function (t) {
        return a0 + 3 * t * a1 + 3 * t * t * a2 + t * t * t * a3
      }
    ...
    divide: function (t) {
      ...
      var q2 = xypic.Frame.Point(x2 + t * (x3 - x2), y2 + t * (y3 -
        y2));
      var q3 = this.cp3;
      return [
    ...
    slice: function (t0, t1) {
      ...
      var q0x = this.px(t0);
      var q0y = this.py(t0);
      var q1x = x1 + 2 * t0 * (x2 - x1) + t0 * t0 * (x3 - 2 * x2 +
      x1);
      var q1y = y1 + 2 * t0 * (y2 - y1) + t0 * t0 * (y3 - 2 * y2 +
      y1);
      var q2x = x2 + t0 * (x3 - x2);
      var q2y = y2 + t0 * (y3 - y2);
      var p0 = xypic.Frame.Point(q0x, q0y);
      var p1 = xypic.Frame.Point(q0x + t1 * (q1x - q0x), q0y + t1 * (
        q1y - q0y));
      var p2 = xypic.Frame.Point(
        q0x + 2 * t1 * (q1x - q0x) + t1 * t1 * (q2x - 2 * q1x +
        q0x),
    ...
    tOfIntersections: function (frame) {
      ...
      if (frame.isRect()) {
        ...
        var ts = [];
        var tsCandidate;
        tsCandidate = xypic.Curve.solutionsOfCubicEq(a3x, a2x, a1x,
          a0x - rx);
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfCubicEq(a3x, a2x, a1x, a0x - lx));
        for (var i = 0; i < tsCandidate.length; i++) {
          var t = tsCandidate[i];
          var y = py(t);
          if (y >= dy && y <= uy) {
        ...
        tsCandidate = xypic.Curve.solutionsOfCubicEq(a3y, a2y, a1y,
          a0y - uy);
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfCubicEq(a3y, a2y, a1y, a0y - dy));
        for (var i = 0; i < tsCandidate.length; i++) {
          var t = tsCandidate[i];
          var x = px(t);
          if (x >= lx && x <= rx) {
    ...
    toString: function () {
      return "CubicBezier(" + this.cp0.x + ", " + this.cp0.y + ")-(" +
        this.cp1.x + ", " + this.cp1.y + ")-(" + this.cp2.x + ", " +
        this.cp2.y + ")-(" + this.cp3.x + ", " + this.cp3.y + ")"
    }
  });
  xypic.Curve.CubicBeziers = xypic.Curve.Subclass({
    ...
    position: function (t) {
      return this.delegate(t, function (cb, s) {
        return cb.position(s)
      }, undefined);
    },
    derivative: function (t) {
      return this.delegate(t, function (cb, s) {
        return cb.derivative(s)
      }, undefined);
    },
    angle: function (t) {
      return this.delegate(t, function (cb, s) {
    ...
    divide: function (t) {
      ...
      divS.push(divB[0]);
      divE.unshift(divB[1]);
      return [xypic.Curve.CubicBeziers(divS), xypic.Curve
        .CubicBeziers(divE)];
    },
    slice: function (t0, t1) {
      if (t0 >= t1) {
    ...
    drawPrimitive: function (svg, dasharray) {
      ...
      for (var i = 1; i < n; i++) {
        ...
        d += " S" + xypic.em2px(cp2.x) + "," + xypic.em2px(-cp2.y) +
          " " + xypic.em2px(cp3.x) + "," + xypic.em2px(-cp3.y);
      }
      svg.createSVGElement("path", {
        "d": d,
    ...
    interpolation: function (ts, xs, ys) {
      var x12 = xypic.Curve.CubicBeziers.cubicSplineInterpolation(ts,
        xs);
      var x1 = x12[0];
      var x2 = x12[1];
      var y12 = xypic.Curve.CubicBeziers.cubicSplineInterpolation(ts,
        ys);
      var y1 = y12[0];
      var y2 = y12[1];
      var i, n = ts.length;
    ...
    cubicSplineInterpolation: function (ts, xs) {
      ...
      var as = new Array(n);
      for (i = 1; i < n; i++) {
        as[i] = 3 * (xs[i + 1] - xs[i]) / hs[i] - 3 * (xs[i] - xs[i -
          1]) / hs[i - 1];
      }
  ...
  xypic.Curve.CubicBSpline = MathJax.Object.Subclass({
    Init: function (s, intCps, e) {
      if (intCps.length < 1) {
        throw xypic.ExecutionError(
          "the number of internal control points of cubic B-spline must be greater than or equal to 1"
          );
      }
      var controlPoints = [];
  ...
  xypic.Curve.Line = MathJax.Object.Subclass({
    ...
    tOfIntersections: function (frame) {
      ...
      if (frame.isRect()) {
        ...
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfLinearEq(a1x, a0x - lx));
        for (var i = 0; i < tsCandidate.length; i++) {
          var t = tsCandidate[i];
          var y = py(t);
          if (y >= dy && y <= uy) {
        ...
        tsCandidate = tsCandidate.concat(xypic.Curve
          .solutionsOfLinearEq(a1y, a0y - dy));
        for (var i = 0; i < tsCandidate.length; i++) {
          var t = tsCandidate[i];
          var x = px(t);
          if (x >= lx && x <= rx) {
    ...
    toShape: function (context, object, main, variant) {
      ...
      if (s.x !== e.x || s.y !== e.y) {
        ...
        if (vshift !== undefined) {
          ...
          shape = xypic.Shape.LineShape(this, object, main, variant,
            bbox);
          context.appendShapeToFront(shape);
          env.angle = angle;
          env.lastCurve = xypic.LastCurve.Line(s, e, env.p, env.c,
    ...
    drawLine: function (svg, object, main, variant, holeRanges) {
      if (holeRanges.isEmpty) {
        ...
        var self = this;
        clippingRanges.foreach(function (range) {
          self.slice(range.start, range.end)._drawLine(svg,
            object, main, variant);
        });
      }
    },
    _drawLine: function (svg, object, main, variant) {
      ...
      if (s.x !== e.x || s.y !== e.y) {
        ...
        case '..':
          this.drawStraightLine(svg, s, e, shift, angle, t, variant,
            AST.xypic.dottedDasharray);
          break;
        case ':':
        case '::':
          this.drawStraightLine(svg, s, e, shift, angle, t, "2", AST
        ...
        case '==':
          ...
          if (len >= dash) {
            var shiftLen = (len - dash) / 2 - Math.floor((len -
              dash) / 2 / dash) * dash;
            shift = {
              x: shiftLen * Math.cos(angle),
              y: shiftLen * Math.sin(angle)
            };
            this.drawStraightLine(svg, s, e, shift, angle, t, (
                main === "==" ? "2" : variant), xypic.em2px(dash) +
              " " + xypic.em2px(dash));
          }
          break;
        case '~':
          ...
          if (len >= wave) {
            ...
            var d = "M" + xypic.em2px(sx) + "," + xypic.em2px(sy) +
              " Q" + xypic.em2px(sx + tx + cx) + "," + xypic.em2px(
                sy - ty - cy) +
              " " + xypic.em2px(sx + 2 * tx) + "," + xypic.em2px(sy -
                2 * ty) +
              " T" + xypic.em2px(sx + 4 * tx) + "," + xypic.em2px(sy -
                4 * ty);
            for (var i = 1; i < n; i++) {
              d += " T" + xypic.em2px(sx + (4 * i + 2) * tx) + "," +
                xypic.em2px(sy - (4 * i + 2) * ty) +
                " T" + xypic.em2px(sx + (4 * i + 4) * tx) + "," +
                xypic.em2px(sy - (4 * i + 4) * ty);
            }
        ...
        case '~~':
          ...
          if (len >= wave) {
            ...
            var d = "";
            for (var i = 0; i <= n; i++) {
              d += " M" + xypic.em2px(sx + 8 * i * tx) + "," + xypic
                .em2px(sy - 8 * i * ty) +
                " Q" + xypic.em2px(sx + (8 * i + 1) * tx + cx) + "," +
                xypic.em2px(sy - (8 * i + 1) * ty - cy) +
                " " + xypic.em2px(sx + (8 * i + 2) * tx) + "," + xypic
                .em2px(sy - (8 * i + 2) * ty) +
                " T" + xypic.em2px(sx + (8 * i + 4) * tx) + "," +
                xypic.em2px(sy - (8 * i + 4) * ty);
            }
            this.drawSquigglyLineShape(svg, d, s, e, cx, cy, variant);
          }
          break;
        default:
          ...
          var dummyContext = xypic.DrawingContext(xypic.Shape.none,
            dummyEnv);
          for (var i = 0; i < n; i++) {
            dummyEnv.c = xypic.Frame.Point(startX + i * ac, startY +
              i * as);
    ...
    drawStraightLine: function (svg, s, e, shift, angle, t, variant,
      dasharray) {
      if (variant === "3") {
        var cx = t * Math.cos(angle + Math.PI / 2);
        var cy = t * Math.sin(angle + Math.PI / 2);
        svg.createSVGElement("line", {
          x1: xypic.em2px(s.x + shift.x),
          y1: -xypic.em2px(s.y + shift.y),
          x2: xypic.em2px(e.x),
          y2: -xypic.em2px(e.y),
          "stroke-dasharray": dasharray
        });
        svg.createSVGElement("line", {
          x1: xypic.em2px(s.x + cx + shift.x),
          y1: -xypic.em2px(s.y + cy + shift.y),
          x2: xypic.em2px(e.x + cx),
          y2: -xypic.em2px(e.y + cy),
          "stroke-dasharray": dasharray
        });
        svg.createSVGElement("line", {
          x1: xypic.em2px(s.x - cx + shift.x),
    ...
    drawSquigglyLineShape: function (svg, d, s, e, cx, cy, variant) {
      ...
      if (variant === "3") {
        ...
        g1 = svg.createGroup(svg.transformBuilder().translate(cx,
        cy));
        g1.createSVGElement("path", {
          d: d
        });
        g2 = svg.createGroup(svg.transformBuilder().translate(-cx, -
          cy));
        g2.createSVGElement("path", {
          d: d
        });
      } else if (variant === "2") {
        g1 = svg.createGroup(svg.transformBuilder().translate(cx / 2,
          cy / 2));
        g1.createSVGElement("path", {
          d: d
        });
        g2 = svg.createGroup(svg.transformBuilder().translate(-cx / 2,
          -cy / 2));
        g2.createSVGElement("path", {
          d: d
        });
  ...
  xypic.CurveSegment = MathJax.Object.Subclass({
    ...
    clippedLineRange: function (ps, lineMin, lineMax) {
      ...
      for (var i = 0; i <= n; i++) {
        es[i] = [i / n, -lineMin[0] * ps[i].x - lineMin[1] * ps[i].y -
          lineMin[2], 1];
      }
      ...
      if (es[0][1] < 0) {
        ...
        for (i = 1; i <= n; i++) {
          ...
          v = -l0i[2] / l0i[0];
          if (v > 0 && v < 1 && (vminAgainstLineMin === undefined ||
              v < vminAgainstLineMin)) {
      ...
      if (es[n][1] < 0) {
        for (i = 0; i < n; i++) {
          ...
          v = -lni[2] / lni[0];
          if (v > 0 && v < 1 && (vmaxAgainstLineMin === undefined ||
              v > vmaxAgainstLineMin)) {
      ...
      for (i = 0; i <= n; i++) {
        es[i] = [i / n, lineMax[0] * ps[i].x + lineMax[1] * ps[i].y +
          lineMax[2], 1];
      }
      ...
      if (es[0][1] < 0) {
        ...
        for (i = 1; i <= n; i++) {
          var l0i = extProd(es[0], es[i]);
          v = -l0i[2] / l0i[0];
          if (v > 0 && v < 1 && (vminAgainstLineMax === undefined ||
              v < vminAgainstLineMax)) {
      ...
      if (es[n][1] < 0) {
        for (i = 0; i < n; i++) {
          var lni = extProd(es[n], es[i]);
          v = -lni[2] / lni[0];
          if (v > 0 && v < 1 && (vmaxAgainstLineMax === undefined ||
              v > vmaxAgainstLineMax)) {
      ...
      return {
        min: this.tmin + vmin * (this.tmax - this.tmin),
        max: this.tmin + vmax * (this.tmax - this.tmin)
      };
    }
  }, {
    findIntersections: function (segment0, segment1) {
      ...
      while (i < n && queue.length > 0) {
        ...
        if (tlen < acc && segment0.paramLength() < acc) {
          // intersection found
          if (swapped) {
            intersections.push([segment1.clip(tmin, tmax)
            .paramRange(), segment0.paramRange()]);
          } else {
            intersections.push([segment0.paramRange(), segment1.clip(
              tmin, tmax).paramRange()]);
          }
          continue;
        }
        if (tlen <= segment1.paramLength() * 0.8) {
          ...
          if (tlen > segment0.paramLength()) {
            ...
            queue.push([segment1.clip(tmin, tmid), segment0, !
              swapped]);
            queue.push([segment1.clip(tmid, tmax), segment0, !
              swapped]);
          } else {
            var newSegment = segment1.clip(tmin, tmax);
            var range0 = segment0.paramRange();
            var mid0 = (range0.min + range0.max) / 2;
            queue.push([newSegment, segment0.clip(range0.min, mid0), !
              swapped]);
            queue.push([newSegment, segment0.clip(mid0, range0.max), !
              swapped]);
          }
        }
      }
  ...
  xypic.CurveSegment.Line = xypic.CurveSegment.Subclass({
    ...
    fatLine: function () {
      var a = (this.p1.y - this.p0.y),
        ...
        c = this.p1.x * this.p0.y - this.p0.x * this.p1.y;
    ...
    drawFatLine: function () {
      ...
      xypic.svgForDebug.createSVGElement("line", {
        x1: xypic.em2px(xmin),
        y1: -xypic.em2px(y(xmin, lmax)),
        x2: xypic.em2px(xmax),
        y2: -xypic.em2px(y(xmax, lmax)),
        "stroke-width": xypic.em2px(0.02 * xypic.oneem),
        stroke: "red"
      });
    }
  });
  xypic.CurveSegment.QuadBezier = xypic.CurveSegment.Subclass({
    Init: function (bezier, tmin, tmax) {
      ...
      this.cp1 = xypic.Frame.Point(
        (1 - tmax) * (1 - tmin) * bezier.cp0.x + (tmin + tmax - 2 *
          tmin * tmax) * bezier.cp1.x + tmin * tmax * bezier.cp2.x,
        (1 - tmax) * (1 - tmin) * bezier.cp0.y + (tmin + tmax - 2 *
          tmin * tmax) * bezier.cp1.y + tmin * tmax * bezier.cp2.y
      );
    ...
    drawFatLine: function () {
      ...
      xypic.svgForDebug.createSVGElement("line", {
        x1: xypic.em2px(xmin),
        y1: -xypic.em2px(y(xmin, lmin)),
        x2: xypic.em2px(xmax),
        y2: -xypic.em2px(y(xmax, lmin)),
        "stroke-width": xypic.em2px(0.02 * xypic.oneem),
        stroke: "blue"
      });
      xypic.svgForDebug.createSVGElement("line", {
  ...
  xypic.CurveSegment.CubicBezier = xypic.CurveSegment.Subclass({
    Init: function (bezier, tmin, tmax) {
      ...
      this.cp0 = bezier.position(tmin);
      this.cp1 = xypic.Frame.Point(
        (1 - tmax) * (1 - tmin) * (1 - tmin) * bezier.cp0.x + (1 -
          tmin) * (2 * tmin + tmax - 3 * tmin * tmax) * bezier.cp1
        .x + tmin * (2 * tmax + tmin - 3 * tmin * tmax) * bezier.cp2
        .x + tmin * tmin * tmax * bezier.cp3.x,
        (1 - tmax) * (1 - tmin) * (1 - tmin) * bezier.cp0.y + (1 -
          tmin) * (2 * tmin + tmax - 3 * tmin * tmax) * bezier.cp1
        .y + tmin * (2 * tmax + tmin - 3 * tmin * tmax) * bezier.cp2
        .y + tmin * tmin * tmax * bezier.cp3.y
      );
      this.cp2 = xypic.Frame.Point(
        (1 - tmin) * (1 - tmax) * (1 - tmax) * bezier.cp0.x + (1 -
          tmax) * (2 * tmax + tmin - 3 * tmin * tmax) * bezier.cp1
        .x + tmax * (2 * tmin + tmax - 3 * tmin * tmax) * bezier.cp2
        .x + tmin * tmax * tmax * bezier.cp3.x,
        (1 - tmin) * (1 - tmax) * (1 - tmax) * bezier.cp0.y + (1 -
          tmax) * (2 * tmax + tmin - 3 * tmin * tmax) * bezier.cp1
        .y + tmax * (2 * tmin + tmax - 3 * tmin * tmax) * bezier.cp2
        .y + tmin * tmax * tmax * bezier.cp3.y
      );
  ...
  xypic.CurveSegment.Arc = xypic.CurveSegment.Subclass({
    ...
    fatLine: function () {
      ...
      var cosp = Math.cos(tp),
        sinp = Math.sin(tp);
      var r = Math.sqrt(rx * rx * sinp * sinp + ry * ry * cosp *
      cosp);
      if (r < AST.xypic.machinePrecision) {
        var Lmin = [1, 0, this.x * ry * cosp + this.y * rx * sinp +
          rx * ry * Math.cos(tm)];
        var Lmax = [1, 0, this.x * ry * cosp + this.y * rx * sinp +
          rx * ry];
      } else {
        var rrx = rx / r;
        var rry = ry / r;
        var Lmin = [-rry * cosp, -rrx * sinp, this.x * rry * cosp +
          this.y * rrx * sinp + rx * ry / r * Math.cos(tm)];
        var Lmax = [-rry * cosp, -rrx * sinp, this.x * rry * cosp +
          this.y * rrx * sinp + rx * ry / r];
      }
      return {
        min: Lmin,
        max: Lmax
    ...
    clip: function (angleMin, angleMax) {
      return xypic.CurveSegment.Arc(this.x, this.y, this.rx, this.ry,
        angleMin, angleMax);
    },
    ...
    clippedRange: function (origLineMin, origLineMax) {
      ...
      var det = r * r - d * d;
      if (det >= 0) {
        var xp = lineMin[0] * d - lineMin[1] * Math.sqrt(r * r - d *
          d);
        var yp = lineMin[1] * d + lineMin[0] * Math.sqrt(r * r - d *
          d);
        var xm = lineMin[0] * d + lineMin[1] * Math.sqrt(r * r - d *
          d);
        var ym = lineMin[1] * d - lineMin[0] * Math.sqrt(r * r - d *
          d);
      ...
      var d0 = -(lineMin[0] * (x + r * Math.cos(angleMin)) + lineMin[
        1] * (y + r * Math.sin(angleMin)) + lineMin[2]);
      var d1 = -(lineMin[0] * (x + r * Math.cos(angleMax)) + lineMin[
        1] * (y + r * Math.sin(angleMax)) + lineMin[2]);
      ...
      var d0 = lineMax[0] * (x + r * Math.cos(angleMin)) + lineMax[
        1] * (y + r * Math.sin(angleMin)) + lineMax[2];
      var d1 = lineMax[0] * (x + r * Math.cos(angleMax)) + lineMax[
        1] * (y + r * Math.sin(angleMax)) + lineMax[2];
  ...
  xypic.LastCurve.Line = xypic.LastCurve.Subclass({
    ...
    sliceHole: function (holeFrame, t) {
      ...
      var line = shape.line;
      var intersections = line.tOfIntersections(
      holeFrame); // ts of the line from start to end.
  ...
  xypic.LastCurve.QuadBezier = xypic.LastCurve.Subclass({
    Init: function (origBezier, tOfShavedStart, tOfShavedEnd,
      ...
      if (!curveShape.isNone) {
        ...
        if (tOfShavedStart > 0) {
          curveShape.sliceHole(xypic.Range(0, tOfShavedStart));
        }
        if (tOfShavedEnd < 1) {
          curveShape.sliceHole(xypic.Range(tOfShavedEnd, 1));
        }
      }
    },
    isDefined: true,
    ...
    sliceHole: function (holeFrame, t) {
      ...
      var intersections = curve.tOfIntersections(
      holeFrame); // ts of the curve from p to c.
      intersections.push(0);
      intersections.push(1);
      intersections.sort();
      var t0 = intersections[0],
  ...
  xypic.LastCurve.CubicBSpline = xypic.LastCurve.Subclass({
    ...
    segments: function () {
      ...
      for (var i = 0; i < n; i++) {
        segments[i] = xypic.CurveSegment.CubicBezier(this.origBezier,
          i / n, (i + 1) / n);
      }
      return segments;
    }
  ...
  xypic.Saving.Base = MathJax.Object.Subclass({
    ...
    toString: function () {
      return "origin:" + this.origin + ", xBase:" + this.xBase +
        ", yBase:" + this.yBase;
    }
  });
    ...
    lookupPos: function (id, errorMessage) {
      ...
      if (pos === undefined) {
        if (errorMessage !== undefined) {
          ...
          throw xypic.ExecutionError('<pos> "' + id +
            '" not defined.');
        }
      } else {
        return pos;
    ...
    toString: function () {
      ...
      for (var id in this.savedPosition) {
        if (this.savedPosition.hasOwnProperty(id)) {
          ...
          savedPositionDesc += id.toString() + ":" + this
            .savedPosition[id];
        }
      }
      return "Env\n  p:" + this.p + "\n  c:" + this.c + "\n  angle:" +
  ...
  AST.Pos.Place.Augment({
    toShape: function (context) {
      ...
      if (env.lastCurve.isDefined) {
        ...
        var t = env.lastCurve.tOfPlace(shouldShaveP, shouldShaveC, f,
          slideEm);
  ...
  AST.Place.Intercept.Augment({
    value: function (context) {
      ...
      if (!tmpEnv.lastCurve.isDefined) {
        tmpEnv.lastCurve = xypic.LastCurve.Line(tmpEnv.p, tmpEnv.c,
          tmpEnv.p, tmpEnv.c, undefined);
      }
      var intersec = [];
      ...
      for (var i = 0; i < thisSegs.length; i++) {
        for (var j = 0; j < thatSegs.length; j++) {
          intersec = intersec.concat(xypic.CurveSegment
            .findIntersections(thisSegs[i], thatSegs[j]));
        }
      }
      if (intersec.length === 0) {
        ...
        var j10 = dp0.y * dt0,
          j11 = -dp1.y * dt1;
        var a00 = j00 * j00 + j10 * j10,
          a01 = j00 * j01 + j10 * j11;
        var a10 = j01 * j00 + j11 * j10,
          a11 = j01 * j01 + j11 * j11;
        ...
        while (!stop && k < n) {
          ...
          do {
            ...
            if ((d0 * d0 + d1 * d1) < goalAccuracy * goalAccuracy * (
                x0 * x0 + x1 * x1)) {
              stop = true;
            } else {
              var newX0 = x0 - d0;
              ...
              var rho = ((f0 * f0 + f1 * f1) - (newF0 * newF0 +
                newF1 * newF1)) / (d0 * (mu * d0 + g0) + d1 * (mu *
                d1 + g1));
              if (rho > 0) {
                x0 = newX0;
                x1 = newX1;
  ...
  AST.Pos.SaveBase.Augment({
    toShape: function (context) {
      var env = context.env;
      env.savePos(this.id, xypic.Saving.Base(env.origin, env.xBase,
        env.yBase));
    }
  });
  ...
  AST.Object.Augment({
    toDropShape: function (context) {
      ...
      if (modifiers.isEmpty) {
        ...
        var tmpEnv = env.duplicate();
        var subcontext = xypic.DrawingContext(xypic.Shape.none,
          tmpEnv);
        var reversedProcessedModifiers = FP.List.empty;
        modifiers.foreach(function (m) {
          m.preprocess(subcontext, reversedProcessedModifiers);
          reversedProcessedModifiers = reversedProcessedModifiers
            .prepend(m);
        });
        ...
        objectShape = modifiers.head.modifyShape(subcontext,
          objectShape, modifiers.tail);
  ...
  AST.ObjectBox.Augment({
    toConnectShape: function (context) {
      ...
      if (s.x !== e.x || s.y !== e.y) {
        var shape = xypic.Curve.Line(s, e).toShape(context, this,
          "196883" /* dummy dir name */ , "");
  ...
  AST.ObjectBox.CompositeObject.Augment({
    toDropShape: function (context) {
      ...
      this.objects.foreach(function (obj) {
        ...
        c = xypic.Frame.combineRect(c, tmpShape.getBoundingBox()
          .toPoint());
      });
      env.c = c;
  ...
  AST.ObjectBox.Xybox.Augment({
    toDropShape: function (context) {
      ...
      env.c = xypic.Frame.Rect(c.x, c.y, {
        l: l,
        r: r,
        u: u,
        d: d
      ...
      var objectShape = xypic.Shape.TranslateShape(c.x, c.y,
      subshape);
      context.appendShapeToFront(objectShape);
      return objectShape;
    }
  ...
  AST.ObjectBox.Text.Augment({
    toDropShape: function (context) {
      var env = context.env;
      var textShape = xypic.Shape.TextShape(env.c, this.math, xypic
        .svgForTestLayout);
      context.appendShapeToFront(textShape);
      env.c = textShape.getBoundingBox();
      env.originalReferencePoint = textShape
  ...
  AST.ObjectBox.Cir.Cir.Segment.Augment({
    toDropShape: function (context, x, y, r) {
      ...
      var circleSegmentShape = xypic.Shape.CircleSegmentShape(x, y,
        sx, sy, r, large, flip, ex, ey);
    ...
    toDropFilledShape: function (context, color, convertToEllipse) {
      ...
      case '--':
        ...
        if (convertToEllipse) {
          ...
          shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y +
            (up - down) / 2, xy.x, xy.y, false, color, xypic.em2px(
              dash) + " " + xypic.em2px(dash));
        } else {
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, false, color, xypic.em2px(dash) + " " +
            xypic.em2px(dash));
        }
        break;
      case '==':
        ...
        if (convertToEllipse) {
          var xy = this.radius.xy(context);
          shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y +
            (up - down) / 2, xy.x, xy.y, true, color, xypic.em2px(
              dash) + " " + xypic.em2px(dash));
        } else {
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, true, color, xypic.em2px(dash) + " " +
            xypic.em2px(dash));
        }
        break;
      case 'o-':
      ...
      case 'oo':
        ...
        var r = xy.x;
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
          up - down) / 2, r, r, true, color, undefined);
        break;
      case 'ee':
        var xy = this.radius.xy(context);
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
          up - down) / 2, xy.x, xy.y, true, color, undefined);
        break;
      case '-,':
        var depth = this.radius.depth(context);
        var radius = this.radius.radius(context);
        shape = xypic.Shape.CompositeShape(
          xypic.Shape.RectangleShape(x, y, left, right, up, down,
            radius, false, color, undefined),
          xypic.Shape.BoxShadeShape(x, y, left, right, up, down,
            depth)
        );
        break;
      case '.o':
        ...
        var r = xy.x;
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
            up - down) / 2, r, r, false, color, AST.xypic
          .dottedDasharray);
        break;
      case '-o':
        var dash = 3 * t;
        ...
        var r = xy.x;
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
            up - down) / 2, r, r, false, color, xypic.em2px(dash) +
          " " + xypic.em2px(dash));
        break;
      case '.e':
        var xy = this.radius.xy(context);
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
            up - down) / 2, xy.x, xy.y, false, color, AST.xypic
          .dottedDasharray);
        break;
      case '-e':
        var dash = 3 * t;
      ...
      case '-':
        if (convertToEllipse) {
          var xy = this.radius.xy(context);
          shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y +
            (up - down) / 2, xy.x, xy.y, false, color, undefined);
        } else {
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, false, color, undefined);
        }
        break;
      case '=':
        if (convertToEllipse) {
          ...
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, true, color, undefined);
        }
        break;
      case '.':
        if (convertToEllipse) {
          ...
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, false, color, AST.xypic.dottedDasharray);
        }
        break;
      case ',':
        var depth = this.radius.depth(context);
        shape = xypic.Shape.BoxShadeShape(x, y, left, right, up, down,
          depth, color);
        break;
      case 'o':
        var xy = this.radius.xy(context);
        var r = xy.x;
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
          up - down) / 2, r, r, false, color, undefined);
        break;
      case 'e':
        var xy = this.radius.xy(context);
        shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y + (
      ...
      case '_\\}':
        ...
        break;
      case '(':
        shape = xypic.Shape.LeftParenthesis(x - left, y + (up -
          down) / 2, up + down, 0, color);
        break;
      case ')':
        shape = xypic.Shape.LeftParenthesis(x + right, y + (up -
          down) / 2, up + down, 180, color);
        break;
      case '^(':
      case '^)':
        shape = xypic.Shape.LeftParenthesis(x + (right - left) / 2,
          y + up, left + right, 270, color);
        break;
      case '_(':
      case '_)':
        shape = xypic.Shape.LeftParenthesis(x + (right - left) / 2,
          y - down, left + right, 90, color);
        break;
      case '*':
        if (c.isCircle()) {
          var xy = this.radius.xy(context);
          shape = xypic.Shape.EllipseShape(x + (right - left) / 2, y +
            (up - down) / 2, xy.x, xy.y, false, "currentColor",
            undefined, color, true);
        } else {
          var radius = this.radius.radius(context);
          shape = xypic.Shape.RectangleShape(x, y, left, right, up,
            down, radius, false, "currentColor", undefined, color,
            true);
        }
        break;
      case '**':
  ...
  AST.ObjectBox.Dir.Augment({
    toDropShape: function (context) {
      ...
      case '||':
        switch (this.variant) {
        case "^":
          shape = xypic.Shape.UpperColumnColumnArrowheadShape(c,
            angle);
          break;
        case "_":
          shape = xypic.Shape.LowerColumnColumnArrowheadShape(c,
            angle);
          break;
        case "2":
      ...
      case "=>":
        ...
        break;
      default:
        var newdirObj = xypic.repositories.dirRepository.get(this
          .main);
        if (newdirObj !== undefined) {
          shape = newdirObj.toDropShape(context);
        } else {
          throw xypic.ExecutionError("\\dir " + this.variant + "{" +
            this.main + "} not defined.");
        }
      }
      context.appendShapeToFront(shape);
      return shape;
    ...
    toConnectShape: function (context) {
      ...
      var e = env.c.edgePoint(env.p.x, env.p.y);
      if (s.x !== e.x || s.y !== e.y) {
        var shape = xypic.Curve.Line(s, e).toShape(context, this, this
          .main, this.variant);
        return shape;
      } else {
        env.angle = 0;
  ...
  AST.ObjectBox.Curve.Augment({
    ...
    toConnectShape: function (context) {
      ...
      if (objectForDrop === undefined && objectForConnect ===
        undefined) {
        objectForConnect = AST.Object(FP.List.empty, AST.ObjectBox
          .Dir("", "-"));
      }
      var thickness = AST.xypic.thickness;
      var c = env.c;
      ...
      case 1:
        var origBezier = xypic.Curve.QuadBezier(s, controlPoints[0],
          e);
        var tOfShavedStart = origBezier.tOfShavedStart(s);
        var tOfShavedEnd = origBezier.tOfShavedEnd(e);
        if (tOfShavedStart === undefined || tOfShavedEnd ===
          undefined || tOfShavedStart >= tOfShavedEnd) {
          env.angle = 0;
          env.lastCurve = xypic.LastCurve.none;
          return xypic.Shape.none;
        }
        shape = origBezier.toShape(context, objectForDrop,
          objectForConnect);
        env.lastCurve = xypic.LastCurve.QuadBezier(origBezier,
          tOfShavedStart, tOfShavedEnd, shape);
        env.angle = Math.atan2(e.y - s.y, e.x - s.x);
        break;
      case 2:
        var origBezier = xypic.Curve.CubicBezier(s, controlPoints[0],
          controlPoints[1], e);
        var tOfShavedStart = origBezier.tOfShavedStart(s);
        var tOfShavedEnd = origBezier.tOfShavedEnd(e);
        if (tOfShavedStart === undefined || tOfShavedEnd ===
        ...
        shape = origBezier.toShape(context, objectForDrop,
          objectForConnect);
        env.lastCurve = xypic.LastCurve.CubicBezier(origBezier,
          tOfShavedStart, tOfShavedEnd, shape);
        env.angle = Math.atan2(e.y - s.y, e.x - s.x);
        break;
      default:
        var spline = xypic.Curve.CubicBSpline(s, controlPoints, e);
        var origBeziers = xypic.Curve.CubicBeziers(spline
          .toCubicBeziers());
        ...
        shape = origBeziers.toShape(context, objectForDrop,
          objectForConnect);
        env.lastCurve = xypic.LastCurve.CubicBSpline(s, e,
          origBeziers, tOfShavedStart, tOfShavedEnd, shape);
        env.angle = Math.atan2(e.y - s.y, e.x - s.x);
        break;
      }
  ...
  AST.Coord.DeltaRowColumn.Augment({
    position: function (context) {
      ...
      if (row === undefined || col === undefined) {
        throw xypic.ExecutionError(
          "xymatrix rows and columns not found for " + this
          .toSring());
      }
      var id = this.prefix + (row + this.dr) + "," + (col + this.dc);
      return context.env.lookupPos(id, 'in entry "' + env
        .xymatrixRow + "," + env.xymatrixCol + '": No ' + this +
        " (is " + id + ") from here.").position(context);
    }
  });
  ...
  AST.Coord.HopsWithPlace.Augment({
    position: function (context) {
      ...
      var id = this.prefix + row + "," + col;
      var pos = context.env.lookupPos(id, 'in entry "' + env
        .xymatrixRow + "," + env.xymatrixCol + '": No ' + this +
        " (is " + id + ") from here.").position(context);
      var c = env.c;
      var tmpEnv = env.duplicate();
      ...
      tmpEnv.lastCurve = xypic.LastCurve.Line(s, e, tmpEnv.p, tmpEnv
        .c, undefined);
      var tmpContext = xypic.DrawingContext(xypic.Shape.none, tmpEnv);
  ...
  AST.Vector.Abs.Augment({
    xy: function (context) {
      return {
        x: xypic.length2em(this.x),
        y: xypic.length2em(this.y)
      };
    },
    angle: function (context) {
  ...
  AST.Vector.Angle.Augment({
    xy: function (context) {
      ...
      var xy = context.env.absVector(Math.cos(angle), Math.sin(
      angle));
      return xy;
    },
    angle: function (context) {
  ...
  AST.Modifier.Augment({
    proceedModifyShape: function (context, objectShape, restModifiers) {
      if (restModifiers.isEmpty) {
        ...
        return restModifiers.head.modifyShape(context, objectShape,
          restModifiers.tail);
      }
    }
  });
  AST.Modifier.Vector.Augment({
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      ...
      objectShape = xypic.Shape.TranslateShape(-d.x, -d.y,
        objectShape);
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
    }
  });
  ...
  AST.Modifier.Shape.Rect.Augment({
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      var c = context.env.c;
      context.env.c = xypic.Frame.Rect(c.x, c.y, {
        l: c.l,
        r: c.r,
        u: c.u,
        d: c.d
  ...
  AST.Modifier.Shape.Circle.Augment({
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      var c = context.env.c;
      context.env.c = xypic.Frame.Ellipse(c.x, c.y, c.l, c.r, c.u, c
        .d);
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
    }
  ...
  AST.Modifier.Shape.ChangeColor.Augment({
    preprocess: function (context, reversedProcessedModifiers) {},
    modifyShape: function (context, objectShape, restModifiers) {
      objectShape = this.proceedModifyShape(context, objectShape,
        restModifiers);
      return xypic.Shape.ChangeColorShape(this.colorName,
      objectShape);
    }
  });
  AST.Modifier.Shape.Alphabets.Augment({
    preprocess: function (context, reversedProcessedModifiers) {
      var modifier = xypic.repositories.modifierRepository.get(this
        .alphabets);
      if (modifier !== undefined) {
        return modifier.preprocess(context,
          reversedProcessedModifiers);
      } else {
  ...
  AST.Modifier.Shape.DefineShape.Augment({
    preprocess: function (context, reversedProcessedModifiers) {
      ...
      xypic.repositories.modifierRepository.put(this.shape, AST
        .Modifier.Shape.CompositeModifiers(processedModifiers));
    },
    modifyShape: function (context, objectShape, restModifiers) {
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
  ...
  AST.Modifier.Shape.CompositeModifiers.Augment({
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      objectShape = this.proceedModifyShape(context, objectShape, this
        .modifiers);
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
    }
  ...
  AST.Modifier.AddOp.Augment({
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      ...
      context.appendShapeToFront(xypic.Shape.InvisibleBoxShape(context
        .env.c));
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
    }
  ...
  AST.Modifier.AddOp.Grow.Augment({
    apply: function (size, c, context) {
      ...
      var margin = (size.isDefault ? {
          x: 2 * env.objectmargin,
          y: 2 * env.objectmargin
        } :
    ...
    modifyShape: function (context, objectShape, restModifiers) {
      ...
      if (env.c !== undefined) {
        ...
        this.options.foreach(function (op) {
          radius = op.getRadius(radius);
        });
        this.options.foreach(function (op) {
          colorName = op.getColorName(colorName);
        });
        var dummyEnv = env.duplicate();
        var dummyContext = xypic.DrawingContext(xypic.Shape.none,
          dummyEnv);
        var frameObject = AST.ObjectBox.Frame(radius, this.main);
        var frameShape = frameObject.toDropFilledShape(dummyContext,
          colorName, env.c.isCircle());
        objectShape = xypic.Shape.CompositeShape(objectShape,
          frameShape);
      }
      return this.proceedModifyShape(context, objectShape,
        restModifiers);
  ...
  AST.Direction.Compound.Augment({
    angle: function (context) {
      var angle = this.dir.angle(context);
      this.rots.foreach(function (rot) {
        angle = rot.rotate(angle, context);
      });
      return angle;
    }
  });
    ...
    toShape: function (context) {
        ...
        AST.Command.Path.Labels(
          FP.List.empty.append(
            AST.Command.Path.Label.At(
              AST.Pos.Place(AST.Place(1, 1, AST.Place.Factor(0), AST
                .Slide(FP.Option.empty))),
      ...
      env.labelsForLastSegmentOnly = FP.Option.Some(
        AST.Command.Path.Labels(
          FP.List.empty.append(
            AST.Command.Path.Label.At(
              AST.Pos.Place(AST.Place(1, 1, AST.Place.Factor(1), AST
                .Slide(FP.Option.empty))),
  ...
  AST.Command.Ar.Form.ChangeStem.Augment({
    toShape: function (context) {
      var env = context.env;
      env.stemConn = AST.Command.Ar.Form.Conn.Connchars(this
      .connchar);
    }
  });
      ...
      env.pathActionForBeforeSegment = FP.Option.Some(
        AST.PosDecor(
          AST.Pos.Coord(
            AST.Coord.C(),
            FP.List.empty.append(
              AST.Pos.ConnectObject(AST.Object(env
                .arrowObjectModifiers, AST.ObjectBox.Curve(
                  FP.List.empty,
                  FP.List.empty.append(
                          ...
                          AST.PosDecor(
                            AST.Pos.Coord(
                              ...
                              FP.List.empty.append(
                                ...
                                AST.Pos.Place(
                                  AST.Place(0, 0, undefined, AST
                                    .Slide(FP.Option.empty))
                                )
                              ).append(
                                AST.Pos.Plus(
                                  AST.Coord.Vector(
                                    AST.Vector.Dir(this.direction,
                                      cpDist)
                                  )
                                )
                              )
                    ...
                    AST.ObjectBox.Curve.PosList.Pos(
                      AST.Pos.Coord(
                        ...
                        FP.List.empty.append(
                          ...
                          AST.Pos.Plus(
                            AST.Coord.Vector(AST.Vector.Dir(this
                              .outDirection, "3pc"))
                          )
                        )
                      )
    ...
    toShape: function (context) {
      ...
      positions.reverse().foreach(function (pos) {
        ...
        points = points.prepend(AST.ObjectBox.Curve.PosList.Pos(
          AST.Pos.Coord(
            AST.Coord.Vector(AST.Vector.InCurBase(xy.x, xy
            .y)),
            FP.List.empty
          )
        ));
  ...
  AST.Command.Ar.Form.AddShape.Augment({
    toShape: function (context) {
      context.env.arrowObjectModifiers = FP.List.empty.append(this
        .shape);
    }
  });
  ...
  AST.Command.Ar.Form.Slide.Augment({
    toShape: function (context) {
      context.env.segmentSlideEm = FP.Option.Some(xypic.length2em(this
        .slideDimen));
    }
  });
  ...
  AST.Command.Ar.Form.Conn.Object.Augment({
    getObject: function (context) {
      var modifiers = context.env.arrowObjectModifiers.concat(this
        .object.modifiers);
  ...
  AST.Command.Path.SetBeforeAction.Augment({
    toShape: function (context) {
      context.env.pathActionForBeforeSegment = FP.Option.Some(this
        .posDecor);
    }
  });
  AST.Command.Path.SetAfterAction.Augment({
    toShape: function (context) {
      context.env.pathActionForAfterSegment = FP.Option.Some(this
        .posDecor);
    }
  });
  AST.Command.Path.AddLabelNextSegmentOnly.Augment({
    toShape: function (context) {
      context.env.labelsForNextSegmentOnly = FP.Option.Some(this
        .labels);
    }
  });
  AST.Command.Path.AddLabelLastSegmentOnly.Augment({
    toShape: function (context) {
      context.env.labelsForLastSegmentOnly = FP.Option.Some(this
        .labels);
    }
  });
  ...
  AST.Command.Path.TurningSegment.Augment({
    toShape: function (context) {
      ...
      var deo = circle.relativeEndPoint(context, r + (circle
        .orient === "^" ? slideEm : -slideEm));
      var t;
  ...
  AST.Command.Path.Turn.Cir.Augment({
    explicitizedCircle: function (context) {
      ...
      return AST.ObjectBox.Cir.Cir.Segment(startDiag, orient,
      endDiag);
    }
  });
  AST.ObjectBox.Cir.Cir.Segment.Augment({
    ...
    relativeEndPoint: function (context, r) {
      var angle;
      angle = this.endPointDegree(context, this
        .relativeStartPointAngle(context)) / 180 * Math.PI;
      return {
        x: r * Math.cos(angle),
        y: r * Math.sin(angle)
      };
  ...
  AST.Command.Path.Turn.Diag.Augment({
    explicitizedCircle: function (context) {
      ...
      var det = (env.c.x - env.p.x) * Math.sin(angle) - (env.c.y - env
        .p.y) * Math.cos(angle);
      orient = (det < 0 ? "^" : "_");
      endDiag = startDiag.turn(orient);
      return AST.ObjectBox.Cir.Cir.Segment(startDiag, orient,
  ...
  AST.Command.Path.Segment.Augment({
    setupPositions: function (context) {
      ...
      if (slideEm !== 0) {
        p = p.move(p.x + slideEm * Math.cos(angle), p.y + slideEm *
          Math.sin(angle));
        c = c.move(c.x + slideEm * Math.cos(angle), c.y + slideEm *
          Math.sin(angle));
      }
      env.p = p;
      env.c = c;
  ...
  AST.Command.Path.Label.Augment({
    toShape: function (context) {
      ...
      if (labelmargin !== 0) {
        ...
        var angle;
        if (!lastCurve.isNone) {
          angle = lastCurve.angle(t) + Math.PI / 2 + (labelmargin >
            0 ? 0 : Math.PI);
        } else {
        ...
        if (bbox !== undefined) {
          ...
          context.appendShapeToFront(xypic.Shape.TranslateShape(
            margin * cos, margin * sin, labelShape));
        }
      } else {
        this.it.toDropShape(context);
      }
      var lastCurve = env.lastCurve;
      if (this.shouldSliceHole && lastCurve.isDefined && t !==
        undefined) {
  ...
  AST.Command.Xymatrix.Augment({
    toShape: function (context) {
      ...
      this.setup.foreach(function (sw) {
        sw.toShape(subcontext);
      });
        ...
        this.rows.map(function (row) {
          ...
          var rowModel = xypic.Xymatrix.Row(
            row.entries.map(function (entry) {
              ...
              if (subEnv.xymatrixPretendEntryWidth
                .isDefined) {
              ...
              var frame = xypic.Frame.Rect(0, 0, {
                l: l,
                r: r,
                u: u,
                d: d
              });
              return xypic.Xymatrix.Entry(localEnv.c, shape,
                entry.decor, frame);
            }),
            orientation
          );
      ...
      */
      ...
      origEnv.c = xypic.Frame.Rect(origEnv.c.x, origEnv.c.y, {
        l: l,
        r: r,
        u: u,
        d: d
      ...
      matrix.rows.foreach(function (row) {
        ...
        row.entries.foreach(function (entry) {
          ...
          var colnum = colIndex + 1;
          var rownum = rowIndex + 1;
          var objectShape = xypic.Shape.TranslateShape(x, y,
            entry.objectShape);
  ...
  xypic.Xymatrix.Row = MathJax.Object.Subclass({
    ...
    getU: function () {
      ...
      this.entries.foreach(function (e) {
        maxU = Math.max(maxU, e.getU(orientation));
      })
      return maxU;
    },
    getD: function () {
      ...
      var maxD = 0;
      this.entries.foreach(function (e) {
        maxD = Math.max(maxD, e.getD(orientation));
      })
      return maxD;
    },
    toString: function () {
  ...
  xypic.Xymatrix.Column = MathJax.Object.Subclass({
    ...
    getL: function () {
      ...
      var maxL = 0;
      this.entries.foreach(function (e) {
        maxL = Math.max(maxL, e.getL(orientation));
      })
      return maxL;
    },
    getR: function () {
      ...
      var maxR = 0;
      this.entries.foreach(function (e) {
        maxR = Math.max(maxR, e.getR(orientation));
      })
      return maxR;
    },
    toString: function () {
  ...
  xypic.Xymatrix.Entry = MathJax.Object.Subclass({
    ...
    getDistanceToEdgePoint: function (frame, angle) {
      var edgePoint = frame.edgePoint(frame.x + Math.cos(angle), frame
        .y + Math.sin(angle));
  ...
  AST.Command.Xymatrix.Setup.ChangeSpacing.Row.Augment({
    toShape: function (context) {
      var env = context.env;
      env.xymatrixRowSepEm = this.addop.applyToDimen(env
        .xymatrixRowSepEm, xypic.length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.ChangeSpacing.Column.Augment({
    toShape: function (context) {
      var env = context.env;
      env.xymatrixColSepEm = this.addop.applyToDimen(env
        .xymatrixColSepEm, xypic.length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.ChangeSpacing.RowAndColumn.Augment({
    toShape: function (context) {
      var env = context.env;
      var sepEm = this.addop.applyToDimen(env.xymatrixRowSepEm, xypic
        .length2em(this.dimen));
  ...
  AST.Command.Xymatrix.Setup.PretendEntrySize.Height.Augment({
    toShape: function (context) {
      context.env.xymatrixPretendEntryHeight = FP.Option.Some(xypic
        .length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.PretendEntrySize.Width.Augment({
    toShape: function (context) {
      context.env.xymatrixPretendEntryWidth = FP.Option.Some(xypic
        .length2em(this.dimen));
    }
  });
  ...
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Margin.Augment({
    toShape: function (context) {
      var env = context.env;
      env.objectmargin = this.addop.applyToDimen(env.objectmargin,
        xypic.length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Width.Augment({
    toShape: function (context) {
      var env = context.env;
      env.objectwidth = this.addop.applyToDimen(env.objectwidth, xypic
        .length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.AdjustEntrySize.Height.Augment({
    toShape: function (context) {
      var env = context.env;
      env.objectheight = this.addop.applyToDimen(env.objectheight,
        xypic.length2em(this.dimen));
    }
  });
  AST.Command.Xymatrix.Setup.AdjustLabelSep.Augment({
    toShape: function (context) {
      var env = context.env;
      env.labelmargin = this.addop.applyToDimen(env.labelmargin, xypic
        .length2em(this.dimen));
    }
  });
  ...
  AST.Command.Xymatrix.Setup.AddModifier.Augment({
    toShape: function (context) {
      var env = context.env;
      env.xymatrixEntryModifiers = env.xymatrixEntryModifiers.prepend(
        this.modifier);
    }
  });
  AST.Command.Xymatrix.Entry.SimpleEntry.Augment({
    toShape: function (context) {
      var env = context.env;
      var defaultWidth = xypic.em2length(env.objectmargin + env
        .objectwidth);
      var defaultHeight = xypic.em2length(env.objectmargin + env
        .objectheight);
      var defaultSizeModifier = AST.Modifier.AddOp(AST.Modifier.AddOp
        .GrowTo(), AST.Modifier.AddOp.VactorSize(AST.Vector.Abs(
          defaultWidth, defaultHeight
        )));
      var margin = xypic.em2length(env.objectmargin);
      var marginModifier = AST.Modifier.AddOp(AST.Modifier.AddOp
      .Grow(), AST.Modifier.AddOp.VactorSize(AST.Vector.Abs(
        margin, margin
      )));
      var modifiers = this.modifiers.concat(env
          .xymatrixEntryModifiers).prepend(defaultSizeModifier)
        .prepend(marginModifier);
      return AST.Object(modifiers, this.objectbox).toDropShape(
        context);
    }
  });
  AST.Command.Xymatrix.Entry.EmptyEntry.Augment({
    toShape: function (context) {
      ...
      var modifiers = env.xymatrixEntryModifiers.prepend(
        defaultSizeModifier).prepend(marginModifier);
      return AST.Object(modifiers, AST.ObjectBox.Empty()).toDropShape(
        context);
    }
  });
  ...
  AST.Command.Twocell.Augment({
    toShape: function (context) {
      ...
      var subEnv = origEnv.duplicate();
      var subcontext = xypic.DrawingContext(xypic.Shape.none, subEnv);
      subEnv.twocellmodmapobject = origEnv.twocellmodmapobject || AST
        .Object(FP.List.empty, AST.ObjectBox.Dir("", "|"));
      subEnv.twocellhead = origEnv.twocellhead || AST.Object(FP.List
        .empty, AST.ObjectBox.Dir("", ">"));
      subEnv.twocelltail = origEnv.twocelltail || AST.Object(FP.List
        .empty, AST.ObjectBox.Dir("", ""));
      subEnv.twocellarrowobject = origEnv.twocellarrowobject || AST
        .Object(FP.List.empty, AST.ObjectBox.Dir("", "=>"));
      subEnv.twocellUpperCurveObjectSpacer = origEnv
        .twocellUpperCurveObjectSpacer;
      subEnv.twocellUpperCurveObject = origEnv
      .twocellUpperCurveObject;
      subEnv.twocellLowerCurveObjectSpacer = origEnv
        .twocellLowerCurveObjectSpacer;
      subEnv.twocellLowerCurveObject = origEnv
      .twocellLowerCurveObject;
  ...
  AST.Command.Twocell.Hops2cell.Augment({
    toShape: function (context, arrow) {
      ...
      var curvatureEm = env.twocellCurvatureEm.getOrElse(this
        .getDefaultCurvature());
      var ncos = Math.cos(antiClockwiseAngle);
      var nsin = Math.sin(antiClockwiseAngle);
      var ucp = this.getUpperControlPoint(s, e, m, curvatureEm, ncos,
        nsin);
      var lcp = this.getLowerControlPoint(s, e, m, curvatureEm, ncos,
        nsin);
      if (env.twocellShouldDrawCurve) {
        ...
        if (objectForDrop === undefined) {
          ...
          if (env.twocellUpperCurveObject !== undefined) {
            objectForConnect = env.twocellUpperCurveObject.getOrElse(
              undefined);
          } else {
            objectForConnect = undefined;
          }
        }
        this.toUpperCurveShape(context, s, ucp, e, objectForDrop,
          objectForConnect);
        if (env.lastCurve.isDefined) {
          env.angle = tangle;
          var ucmp = this.getUpperLabelPosition(s, e, m, curvatureEm,
            ncos, nsin);
          var uangle = this.getUpperLabelAngle(antiClockwiseAngle, s,
            e, m, curvatureEm, ncos, nsin);
          env.twocellUpperLabel.foreach(function (l) {
            l.toShape(context, ucmp, Math.cos(uangle), Math.sin(
              uangle), tangle);
          });
        ...
        if (objectForDrop === undefined) {
          ...
          if (env.twocellLowerCurveObject !== undefined) {
            objectForConnect = env.twocellLowerCurveObject.getOrElse(
              undefined);
          } else {
            objectForConnect = undefined;
          }
        }
        this.toLowerCurveShape(context, s, lcp, e, objectForDrop,
          objectForConnect);
        if (env.lastCurve.isDefined) {
          env.angle = tangle;
          var lcmp = this.getLowerLabelPosition(s, e, m, curvatureEm,
            ncos, nsin);
          var langle = this.getLowerLabelAngle(antiClockwiseAngle, s,
            e, m, curvatureEm, ncos, nsin);
          env.twocellLowerLabel.foreach(function (l) {
            l.toShape(context, lcmp, Math.cos(langle), Math.sin(
              langle), tangle);
          });
      ...
      env.c = this.getDefaultArrowPoint(s, e, m, curvatureEm, ncos,
        nsin);
    ...
    _toCurveShape: function (context, s, cp, e, objectForDrop,
      objectForConnect) {
      var env = context.env;
      ...
      var curveShape = origBezier.toShape(context, objectForDrop,
        objectForConnect);
      env.lastCurve = xypic.LastCurve.QuadBezier(origBezier,
        tOfShavedStart, tOfShavedEnd, curveShape);
    },
    targetPosition: function (context) {
      ...
      if (row === undefined || col === undefined) {
        throw xypic.ExecutionError(
          "rows and columns not found for hops [" + this.hops + "]");
      }
  ...
  AST.Command.Twocell.Twocell.Augment({
    getUpperControlPoint: function (s, e, midPoint, curvatureEm, ncos,
      nsin) {
      return xypic.Frame.Point(
    ...
    getLowerControlPoint: function (s, e, midPoint, curvatureEm, ncos,
      nsin) {
      return xypic.Frame.Point(
        midPoint.x - curvatureEm * ncos,
        midPoint.y - curvatureEm * nsin
    ...
    getUpperLabelPosition: function (s, e, midPoint, curvatureEm, ncos,
      nsin) {
      return xypic.Frame.Point(
    ...
    getLowerLabelPosition: function (s, e, midPoint, curvatureEm, ncos,
      nsin) {
      return xypic.Frame.Point(
        midPoint.x - 0.5 * curvatureEm * ncos,
        midPoint.y - 0.5 * curvatureEm * nsin
    ...
    getUpperLabelAngle: function (antiClockwiseAngle, s, e, midPoint,
      curvatureEm, ncos, nsin) {
      var rot = (curvatureEm < 0 ? Math.PI : 0);
      return antiClockwiseAngle + rot;
    },
    getLowerLabelAngle: function (antiClockwiseAngle, s, e, midPoint,
      curvatureEm, ncos, nsin) {
      var rot = (curvatureEm < 0 ? 0 : Math.PI);
      return antiClockwiseAngle + rot;
    },
    getDefaultArrowPoint: function (s, e, midPoint, curvatureEm, ncos,
      nsin) {
      return midPoint;
    },
    toUpperCurveShape: function (context, s, cp, e, objectForDrop,
      objectForConnect) {
      this._toCurveShape(context, s, cp, e, objectForDrop,
        objectForConnect);
    },
    toLowerCurveShape: function (context, s, cp, e, objectForDrop,
      objectForConnect) {
      this._toCurveShape(context, s, cp, e, objectForDrop,
        objectForConnect);
    },
    getDefaultCurvature: function () {
      return 3.5 * AST.xypic.lineElementLength;
    },
    hasUpperTips: true,
    hasLowerTips: true
  });
  AST.Command.Twocell.UpperTwocell.Augment({
    ...
    toLowerCurveShape: function (context, s, cp, e, objectForDrop,
      ...
      if (shavedS.x !== shavedE.x || shavedS.y !== shavedE.y) {
        context.env.lastCurve = xypic.LastCurve.Line(shavedS, shavedE,
          s, e, undefined);
      } else {
    ...
    getDefaultCurvature: function () {
      return 7 * AST.xypic.lineElementLength;
    },
    hasUpperTips: true,
    hasLowerTips: false
  });
  ...
  AST.Command.Twocell.CompositeMap.Augment({
    ...
    getMidBoxSize: function () {
      return 0.5 * AST.xypic.lineElementLength;
    },
    getDefaultCurvature: function () {
      return 3.5 * AST.xypic.lineElementLength;
    },
  ...
  AST.Command.Twocell.Switch.SetCurvature.Augment({
    setup: function (context) {
      ...
      if (this.nudge.isOmit) {
        ...
        env.twocellCurvatureEm = FP.Option.Some(this.nudge.number *
          AST.xypic.lineElementLength);
      }
    }
  });
  ...
  AST.Command.Twocell.Label.Augment({
    ...
    getDefaultLabelOffset: function () {
      return AST.xypic.lineElementLength;
    }
  });
  ...
  AST.Command.Twocell.Arrow.WithOrientation.Augment({
    ...
    toArrowShape: function (context, labelOrigin) {
      ...
      case '^':
        ...
        env.c = xypic.Frame.Point(
          c.x + AST.xypic.lineElementLength * Math.cos(angle - Math
            .PI / 2),
          c.y + AST.xypic.lineElementLength * Math.sin(angle - Math
            .PI / 2)
        );
      ...
      case '=':
        var angle = env.angle;
        var shape = xypic.Shape.TwocellEqualityArrowheadShape(env.c,
          env.angle);
        context.appendShapeToFront(shape);
        env.c = xypic.Frame.Point(
          c.x + AST.xypic.lineElementLength * Math.cos(angle + Math
  ...
  AST.Command.Twocell.Arrow.WithPosition.Augment({
    ...
    toArrowShape: function (context, labelOrigin) {
      ...
      if (!nudge.isOmit) {
        env.c = xypic.Frame.Point(
          arrowPos.x + AST.xypic.lineElementLength * Math.cos(
            angle + Math.PI / 2),
          arrowPos.y + AST.xypic.lineElementLength * Math.sin(
            angle + Math.PI / 2)
        );
        this.labelObject.toDropShape(context);
      }
  ...
  AST.Pos.Xyimport.TeXCommand.Augment({
    toShape: function (context) {
      ...
      if (xyWidth === 0 || xyHeight === 0) {
        throw xypic.ExecutionError(
          "the 'width' and 'height' attributes of the \\xyimport should be non-zero."
          );
      }
      var c = subEnv.c;
      ...
      if (imageWidth === 0 || imageHeight === 0) {
        throw xypic.ExecutionError(
          "the width and height of the graphics to import should be non-zero."
          );
      }
      ...
      var shape = xypic.Shape.TranslateShape(dx, dy, subcontext
      .shape);
      context.appendShapeToFront(shape);
    }
  });
  AST.Pos.Xyimport.Graphics.Augment({
    toShape: function (context) {
      ...
      if (!subEnv.includegraphicsWidth.isDefined || !subEnv
        .includegraphicsHeight.isDefined) {
        throw xypic.ExecutionError(
      ...
      if (imageWidth === 0 || imageHeight === 0) {
        throw xypic.ExecutionError(
          "the 'width' and 'height' attributes of the \\includegraphics should be non-zero."
          );
      }
      var xOffset = this.xOffset;
      var yOffset = this.yOffset;
      ...
      origEnv.setXBase(imageWidth / xyWidth, 0);
      origEnv.setYBase(0, imageHeight / xyHeight);
      var imageShape = xypic.Shape.ImageShape(origEnv.c, graphics
        .filepath);
  ...
  AST.Command.Includegraphics.Attr.Width.Augment({
    setup: function (context) {
      var env = context.env;
      env.includegraphicsWidth = FP.Option.Some(xypic.length2em(this
        .dimen));
    }
  });
  AST.Command.Includegraphics.Attr.Height.Augment({
    setup: function (context) {
      var env = context.env;
      env.includegraphicsHeight = FP.Option.Some(xypic.length2em(this
        .dimen));
    }
  });
...
MathJax.Hub.Register.StartupHook("HTML-CSS Xy-pic Require", function () {
  ...
  var setupHTMLCSSMeasure = function () {
    xypic.length2em = function (len) {
      return HTMLCSS.length2em(len);
    }
    xypic.oneem = xypic.length2em("1em");
    xypic.em2length = function (len) {
      return (len / xypic.oneem) + "em";
    }
    xypic.Em = function (x) {
      return HTMLCSS.Em(x);
    }
    xypic.em = HTMLCSS.em;
    xypic.em2px = function (n) {
      return Math.round(n * HTMLCSS.em * 100) / 100;
    }
    ...
    AST.xypic.axisHeightLength = xypic.axis_height * xypic.length2em(
      "10pt");
    AST.xypic.dottedDasharray = "" + xypic.oneem + " " + xypic.em2px(AST
      .xypic.thickness);
  };
  AST.xypic.Augment({
    toHTML: function (span) {
        ...
        _draw: function (svg, test) {
          ...
          var mathSpan = HTMLCSS.Element("span", {
            ...
            style: {
              ...
              "position": "absolute",
              color: svg
              .getCurrentColor() /*, "border":"0.1px dashed" */
            }
          });
          ...
          var clearSpanId = function (mml) {
            if (mml) {
              if (mml.hasOwnProperty("spanID")) {
                delete mml.spanID;
              }
              if (mml.data) {
                for (var i = 0, n = mml.data.length; i <
                  n; i++) {
          ...
          var H = base.bbox.h + p,
            D = base.bbox.d + p,
            W = base.bbox.w + 2 * p;
          var frame = HTMLCSS.createFrame(stack, H + D, 0, W, 0,
            "none");
          frame.id = "MathJax-frame-" + math.spanID + HTMLCSS
            .idPostfix;
          ...
          if (!test) {
            ...
            mathSpan.setAttribute("y", -c.y - halfHD - origin
              .y - stack.offsetTop / HTMLCSS.em + H);
      ...
      if (xypicData) {
        ...
        if (box !== undefined) {
          ...
          svg.setAttribute("viewBox", [xypic.em2px(box.x - box.l - p),
              -xypic.em2px(box.y + box.u + p), xypic.em2px(box.l +
                box.r + 2 * p), xypic.em2px(box.u + box.d + 2 * p)]
            .join(" "));
          ...
          for (var i = 0; i < c; i++) {
            ...
            to.style.left = "" + xypic.em2px(x + box.l + p * xypic
              .oneem) + "px";
            to.style.top = "" + xypic.em2px(y - xypic.axis_height) +
              "px";
          }
          bbox = {
            h: (box.u + p),
  ...
  AST.xypic.newdir.Augment({
    toHTML: function (span) {
      var newdir = this.cmd;
      xypic.repositories.dirRepository.put(newdir.dirMain, newdir
        .compositeObject);
      return span;
    }
  });
  AST.xypic.includegraphics.Augment({
    toHTML: function (span) {
      ...
      if (!env.includegraphicsWidth.isDefined || !env
        .includegraphicsHeight.isDefined) {
        throw xypic.ExecutionError(
          "the 'width' and 'height' attributes of the \\includegraphics are required."
          );
...
MathJax.Hub.Register.StartupHook("SVG Xy-pic Require", function () {
  ...
  var setupSVGMeasure = function (mu, scale) {
    xypic.length2em = function (len) {
      return SVG.length2em(len, mu, 1 / SVG.em) * scale;
    }
    xypic.oneem = xypic.length2em("1em");
    xypic.em2length = function (len) {
      return (len / xypic.oneem) + "em";
    ...
    xypic.em = SVG.em;
    xypic.em2px = function (n) {
      return Math.round(n * SVG.em * 100) / 100;
    }
    ...
    toSVG: function (HW, DD) {
      ...
      xypic.Shape.TextShape.Augment({
        _draw: function (svg, test) {
          ...
          var x = c.x - box.w / 2;
          var y = c.y - (box.h + box.d) / 2 + box.d + xypic
            .axis_height;
          var H = box.h + p;
          var D = box.d + p;
          var W = box.w + 2 * p;
          ...
          if (!test) {
            ...
            var localSVG = BBOX.G({
              ...
              fill: color,
              "stroke-thickness": 0,
              transform: "scale(" + SVG.em +
                ") matrix(1 0 0 -1 0 0) translate(" + xypic
                .em2px(x / SVG.em) + ", " + xypic.em2px((c
                  .y - (H - D) / 2) / SVG.em) + ")"
            }).With({
              removeable: false
            });
      ...
      if (xypicData) {
        ...
        if (shapeBBox !== undefined) {
          ...
          bbox = {
            h: (box.u + p + xypic.axis_height),
            d: (box.d + p - xypic.axis_height),
            w: (box.r + box.l + 2 * p),
            l: (-box.l - p),
            r: (box.r + p)
          }
          ...
          xypicBBOX.element.setAttribute("transform", "scale(" + (1 /
              SVG.em) + ") matrix(1 0 0 -1 0 0) translate(0," +
            xypic.em2px(-xypic.axis_height) + ")");
          svg.Add(xypicBBOX);
          // FIXME
          svg.x += box.l + p;
          svg.w -= box.l + p;
  ...
  AST.xypic.includegraphics.Augment({
    toSVG: function (HW, DD) {
      ...
      var c = env.c;
      c = c.toRect({
        u: imageHeight - xypic.axis_height,
        d: xypic.axis_height,
        l: 0,
        r: imageWidth
      });
      ...
      var bbox = {
        h: (box.u + xypic.axis_height),
        d: (box.d - xypic.axis_height),
        w: (box.r + box.l),
        l: (-box.l),
        r: (box.r)
      }
      this.SVGhandleSpace(svg);
      var xypicBBOX = BBOX.XYPIC(bbox, 0, 0, xypicSVG.drawArea);
      xypicBBOX.element.setAttribute("transform", "scale(" + (1 / SVG
          .em) + ") matrix(1 0 0 -1 0 0) translate(0," + xypic
        .em2px(-xypic.axis_height) + ")");
      svg.Add(xypicBBOX);
      svg.x += box.l;
      svg.w -= box.l;
      this.SVGhandleColor(svg);
